...
var peachpayi18n = {
    ...
    "bg-BG": {
        ...
        "Place order": "Поръчай",
        "Place purchase order": "Поставете поръчка за покупка",
    ...
    "bs-BA": {
        ...
        "Pay with PayPal": "Platite PayPal-om",
        ...
        "Place purchase order": "Stavite narudžbu",
        ...
        "You might also like...": "Možda će vam se svideti i...",
        "additional": "dodatno",
        "and": "i",
        "apply": "primijeniti",
        "coupon": "kupon",
    ...
    "cs-CZ": {
        ...
        "Place purchase order": "Zadejte nákupní objednávku",
    ...
    "da-DK": {
        ...
        "Place purchase order": "Afgiv indkøbsordre",
    ...
    "el": {
        ...
        "Place purchase order": "Κάντε παραγγελία αγοράς",
        ...
        "Select a state": "Επιλέξτε μια κατάσταση",
    ...
    "it": {
        ...
        "Place purchase order": "Effettuare l'ordine di acquisto",
    ...
    "lb-LU": {
        ...
        "Save and close": "Späicheren a zoumaachen",
    ...
    "ro-RO": {
        ...
        "Place purchase order": "Plasați comanda de cumpărare",
    ...
    "sv-SE": {
        ...
        "Place purchase order": "Gör inköpsorder",
    ...
    "th": {
        ...
        "Place purchase order": "สั่งซื้อสินค้า",
...
var Environment = {
    ...
    isOurStore: function () {
        var address = new URL('https://' + MerchantConfiguration.hostName());
        var domain = address.host + (address.pathname !== '/' ? address.pathname : '');
...
function renderAdditionalFields(fieldData, fieldOrder) {
    ...
    (_d = $qs('#additional-fields-new')) === null || _d === void 0 ? void 0 : _d.addEventListener('change', syncFields);
    (_e = $qs('#additional-fields-existing')) === null || _e === void 0 ? void 0 : _e.addEventListener('change', syncFields);
    $qsAll('.pp-accordion-header').forEach(function ($ah) {
        ...
        var $inner = $ah.nextElementSibling;
        if ($inner) {
            var $input_1 = $inner.querySelector('.extra-field');
            if ($input_1) {
                var inputIsInitial_1 = function () {
                    var isInitial;
                    if ($input_1.type !== 'radio') {
                        isInitial = $input_1.value === '';
                    }
                    else {
                ...
                displayInputStatus($ah, inputIsInitial_1());
...
function generateFields(fieldData, fieldOrder) {
    ...
    if (fieldOrder.length === 1) {
        ...
        if (existPageElement) {
            ...
            existPageElement.innerHTML += "<a href=\"#\" role=\"button\" id=\"pp-additional-cancel\" class=\"pp-slide-up-cancel pp-section-mt\">\n\t\t\t<span class=\"exit-back-btn\">".concat(getLocaleText('Save and close'), "</span>\n\t\t</a>");
...
var PaymentConfiguration = {
    ...
    eligibleMethod: function (providerKey, methodKey, index) {
        ...
        if (method.supports.minimumTotal && method.supports.minimumTotal > cartsTotal) {
            return false;
        }
...
function initBillingFormReturning(message) {
    var _a, _b, _c, _d;
    return "<form id=\"pp-info-form-returning\" class=\"pp-info-form pp-info-form-returning flex col\"><div class=\"flex col pp-form-rows-container\">" + formGenerator((_b = (_a = message.phpData) === null || _a === void 0 ? void 0 : _a.billing_fields) !== null && _b !== void 0 ? _b : [], (_d = (_c = message.phpData) === null || _c === void 0 ? void 0 : _c.billing_fields_order) !== null && _d !== void 0 ? _d : [], 'billing') + '</div></form>';
}
function installCustomerFormFields(message) {
    ...
    (_b = $qs('#pp-info-existing')) === null || _b === void 0 ? void 0 : _b.insertAdjacentHTML('afterbegin', returningForm);
}
...
function initCustomerEvents(message) {
    ...
    (_b = $qs('#open-shipping-details')) === null || _b === void 0 ? void 0 : _b.addEventListener('change', function (event) { return __awaiter(_this, void 0, void 0, function () {
    ...
    (_c = $qs('.pp-info-form-new')) === null || _c === void 0 ? void 0 : _c.addEventListener('change', function () { return setTimeout(function () {
        syncCustomerFieldChanges('.pp-info-form-new');
    }); });
    (_d = $qs('.pp-info-form-returning')) === null || _d === void 0 ? void 0 : _d.addEventListener('change', function () {
        handleReturningInfoformChanges();
    });
    ...
    store.subscribe(function () {
        ...
        var customerData = JSON.stringify(customer) + Environment.customer.existing() + PeachPayCustomer.shipToDifferentAddress() + Environment.modalUI.page();
        if (customerData !== previousCustomerData) {
            previousCustomerData = customerData;
            renderCountryAndStateList((_f = (_e = message.phpData) === null || _e === void 0 ? void 0 : _e.wc_location_info) !== null && _f !== void 0 ? _f : undefined);
            renderCorrectProvinceField(message.phpData);
        ...
        if (Environment.modalUI.page() === 'info' || Environment.modalUI.page() === 'returning') {
            setInProgressCustomer(customer);
        }
        if (Environment.modalUI.page() === 'info' || Environment.modalUI.page() === 'shipping') {
            if (Carts.virtual() && Feature.enabled(FeatureFlag.VIRTUAL_PRODUCT_FIELDS)) {
                hideShippingDetails(true, (_h = (_g = message.phpData) === null || _g === void 0 ? void 0 : _g.billing_fields) !== null && _h !== void 0 ? _h : [], (_k = (_j = message.phpData) === null || _j === void 0 ? void 0 : _j.billing_fields_order) !== null && _k !== void 0 ? _k : []);
                $qs('#shipping-options-container-address', function (element) {
                    element.classList.add('pp-opacity-0');
                });
                $qs('span[data-i18n=", "]', function (element) {
                    element.classList.add('hide');
                });
                $qs('#pp-shipping-options', function ($element) { return $element.classList.add('hide'); });
                (_l = $qs('#shipping-details fieldset')) === null || _l === void 0 ? void 0 : _l.setAttribute('disabled', '');
                $qs('#open-shipping-details', function ($element) { return $element.disabled = true; });
                $qs('#pp-refresh-shipping-options', function ($element) {
                    if (($element === null || $element === void 0 ? void 0 : $element.style.display) == 'block') {
                        $element.style.display = 'none';
                    }
                });
            }
            if (Feature.enabled(FeatureFlag.USE_WC_COUNTRY_LOCALE)) {
                wcCountryLocaleRuleRender(Environment.modalUI.page());
            }
        }
...
function hideShippingDetails(hide, fieldData, fieldOrder) {
    ...
    var fieldInfo = (_c = (_b = (_a = GLOBAL.phpData) === null || _a === void 0 ? void 0 : _a.wc_location_info) === null || _b === void 0 ? void 0 : _b.country_locale_data[info.country()]) === null || _c === void 0 ? void 0 : _c.state;
    if (hide) {
        customerDataRequiredFields.forEach(function (fieldName) {
            if ((fieldName === 'billing_country' || fieldName === 'billing_state') && !isRequiredField(fieldName, fieldData, fieldInfo)) {
                $qs(".".concat(formName, " [name=\"").concat(fieldName, "\"]"), function ($element) {
        ...
        customerDataRequiredFields.forEach(function (fieldName) {
            ...
            if (fieldName === 'billing_state') {
                $qs(".".concat(formName, " [name=\"").concat(fieldName, "\"]"), function ($element) {
                    $element.required = isRequiredField(fieldName, fieldData, fieldInfo);
                });
                return;
            }
...
function handleReturningInfoformChanges() {
    var _a, _b;
    (_a = $qs('#pp-ship-to-existing-save')) === null || _a === void 0 ? void 0 : _a.removeAttribute('disabled');
    (_b = $qs('#pp-ship-to-existing-save')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', returningInfoFormSaveClicked);
}
function wcCountryLocaleRuleRender(page) {
    ...
    var fieldStateFieldInfo = (_g = (_f = (_e = GLOBAL.phpData) === null || _e === void 0 ? void 0 : _e.wc_location_info) === null || _f === void 0 ? void 0 : _f.country_locale_data[info.country()]) === null || _g === void 0 ? void 0 : _g.state;
    var fieldPostalCodeFieldInfo = (_k = (_j = (_h = GLOBAL.phpData) === null || _h === void 0 ? void 0 : _h.wc_location_info) === null || _j === void 0 ? void 0 : _j.country_locale_data[info.country()]) === null || _k === void 0 ? void 0 : _k.postcode;
    var fieldCityFieldInfo = (_o = (_m = (_l = GLOBAL.phpData) === null || _l === void 0 ? void 0 : _l.wc_location_info) === null || _m === void 0 ? void 0 : _m.country_locale_data[info.country()]) === null || _o === void 0 ? void 0 : _o.city;
    if (fieldStateFieldInfo) {
        wcStatefieldRule(fieldStateFieldInfo, section);
    }
    else {
        unhideFields('state', section, fieldData);
    }
    if (fieldPostalCodeFieldInfo) {
        wcPostalCodeFieldRule(fieldPostalCodeFieldInfo, section);
    }
    else {
        unhideFields('postcode', section, fieldData);
    }
    if (fieldCityFieldInfo) {
        wcCityFieldRule(fieldCityFieldInfo, section);
    }
    else {
        unhideFields('city', section, fieldData);
    }
}
function wcStatefieldRule(stateFieldInfo, section) {
    ...
    if ((stateFieldInfo === null || stateFieldInfo === void 0 ? void 0 : stateFieldInfo.hidden) !== undefined && stateFieldInfo.hidden) {
        $qs("#".concat(stateField), function ($element) {
            var _a;
            ...
            if (list !== undefined) {
                for (var i = 0; i < list.length; i++) {
                    ...
                    if (list[i].id !== stateField && list[i].id !== '') {
...
function wcPostalCodeFieldRule(postcodeFieldInfo, section) {
    var _a, _b, _c, _d;
    ...
    if ((postcodeFieldInfo === null || postcodeFieldInfo === void 0 ? void 0 : postcodeFieldInfo.hidden) !== undefined && postcodeFieldInfo.hidden) {
        $qs("#".concat(postcodeField), function ($element) {
            var _a;
            $element.setAttribute('style', 'display : none;');
            var list = (_a = $element.closest('.pp-form-row')) === null || _a === void 0 ? void 0 : _a.children;
            if (list !== undefined) {
                for (var i = 0; i < list.length; i++) {
                    ...
                    if (list[i].id !== postcodeField && list[i].id !== '') {
                        list[i].setAttribute('style', 'flex-grow : 1;');
                    }
                }
            }
        });
        $qs("#pp-info-form [name=\"".concat(section, "_postcode\"]"), function ($element) {
...
function wcCityFieldRule(cityFieldInfo, section) {
    var _a, _b, _c, _d;
    var fieldData = section === 'billing' ? (_b = (_a = GLOBAL.phpData) === null || _a === void 0 ? void 0 : _a.billing_fields) !== null && _b !== void 0 ? _b : [] : (_d = (_c = GLOBAL.phpData) === null || _c === void 0 ? void 0 : _c.shipping_fields) !== null && _d !== void 0 ? _d : [];
    $qs("#pp-info-form [name=\"".concat(section, "_city\"]"), function ($element) {
        $element.required = isRequiredField("".concat(section, "_city"), fieldData, cityFieldInfo);
    });
}
function unhideFields(fieldName, section, fieldData) {
    var _a, _b, _c, _d;
    var fieldAttributeName = section + '_' + fieldName;
    $qs("#pp-info-form [name=\"".concat(fieldAttributeName, "\"]"), function ($element) {
    ...
    if (enabledField) {
        $qs("#".concat(fieldAttributeName, "-field"), function ($element) {
            var _a;
            $element.removeAttribute('style');
            var list = (_a = $element.closest('.pp-form-row')) === null || _a === void 0 ? void 0 : _a.children;
            if (list !== undefined) {
                for (var i = 0; i < list.length; i++) {
                    ...
                    if (list[i].id !== "#".concat(fieldAttributeName, "-field") && list[i].id !== '') {
                        list[i].removeAttribute('style');
                    }
                }
            }
...
function syncCustomerFieldChanges(formIdentifier) {
    $qsAll(formIdentifier, function ($form) {
...
function renderCorrectProvinceField(phpData) {
    var merchantShipping = MerchantConfiguration.general.wcLocationInfoData();
    if (merchantShipping) {
        var infoForms = [
            {
                name: ".pp-info-form".concat(Environment.customer.existing() ? '-returning' : '-new'),
                section: 'billing'
            }
        ];
        if (PeachPayCustomer.shipToDifferentAddress()) {
        ...
        infoForms.forEach(function (_a) {
            ...
            var info = section === 'billing' ? PeachPayCustomer.billing : PeachPayCustomer.shipping;
            var _e = stateProvinceOrCounty(info.country()), defaultOption = _e[0], label = _e[1];
            var stateOrProvinceOptions = (_b = merchantShipping.allowed_states_or_provinces[info.country()]) !== null && _b !== void 0 ? _b : {};
            ...
            if (stateOrProvinceOptions && Object.keys(stateOrProvinceOptions).length > 0) {
                $qs("".concat(name, " #").concat(stateId), function ($stateOrProvincesSelect) {
                    var _a, _b, _c;
                    ...
                    $qs("".concat(name, " label[for=\"dynamic-states\"]"), function ($element) { return $element.textContent = label !== null && label !== void 0 ? label : defaultOption; });
                    $stateOrProvincesSelect.required = isRequiredField("".concat(section, "_state"), section === 'billing' ? (_a = phpData.billing_fields) !== null && _a !== void 0 ? _a : [] : (_b = phpData.shipping_fields) !== null && _b !== void 0 ? _b : []);
                ...
                $qs("".concat(name, " label[for=\"").concat(stateId, "\"]"), function ($element) {
                    $element.textContent = label !== null && label !== void 0 ? label : defaultOption;
                    $element.classList.remove('hide');
                });
                $qs("".concat(name, " #").concat(provinceId), function ($stateOrProvincesText) {
                ...
                (_c = $qs("".concat(name, " label[for=\"").concat(provinceId, "\"]"))) === null || _c === void 0 ? void 0 : _c.classList.add('hide');
            }
            else {
                $qs("".concat(name, " #").concat(stateId), function ($stateOrProvincesSelect) {
                    var _a, _b;
                    ...
                    (_a = $qs("".concat(name, " label[for=\"dynamic-states\"]"))) === null || _a === void 0 ? void 0 : _a.classList.add('hide');
                    var chevron = (_b = $stateOrProvincesSelect.parentNode) === null || _b === void 0 ? void 0 : _b.lastElementChild;
                    chevron === null || chevron === void 0 ? void 0 : chevron.classList.add('hide');
                });
                (_d = $qs("".concat(name, " label[for=\"").concat(stateId, "\"]"))) === null || _d === void 0 ? void 0 : _d.classList.add('hide');
                $qs("".concat(name, " #").concat(provinceId), function ($stateOrProvincesText) {
                ...
                $qs("".concat(name, " label[for=\"").concat(provinceId, "\"]"), function ($element) {
                    $element.textContent = label !== null && label !== void 0 ? label : defaultOption;
                    $element.classList.remove('hide');
                });
            }
...
function renderCountryAndStateList(merchantLocationInfo) {
    ...
    infoForms.forEach(function (_a) {
        var name = _a.name, section = _a.section;
        var $countries = $qs("".concat(name, " #").concat(section, "_country"));
        if ($countries) {
...
function renderCustomerFields(customer) {
    var infoForms = [
        ".pp-info-form".concat(Environment.customer.existing() ? '-returning' : '-new')
    ];
    if (PeachPayCustomer.shipToDifferentAddress()) {
        infoForms.push('#pp-different-shipping-details');
    }
    infoForms.forEach(function (infoFormName) {
        Object.keys(customer.form_fields).forEach(function (key) {
            $qsAll("".concat(infoFormName, " #").concat(key, "-field [name=\"").concat(key, "\"]"), function (input) {
...
function renderCustomerHeader(customer) {
    ...
    if (PeachPayCustomer.shipToDifferentAddress()) {
        ...
        var section_1 = 'billing';
        var shortAddress_1 = getShortAddress();
        var fullAddress_1 = getFullAddress(section_1);
        var fullName_1 = getFullName(section_1);
        $qsAll("#existing-email", function ($element) { return $element.innerHTML = customer.form_fields["".concat(section_1, "_email")]; });
...
function openSlideUpView(modalName) {
    ...
    var tapToClose = function (e) {
        ...
        (_a = $qs("#pp-".concat(modalName, "-cancel .exit-back-btn"))) === null || _a === void 0 ? void 0 : _a.removeEventListener('click', tapToClose);
        if (modalName === 'cart') {
    ...
    var cancelAndClose = function (e) {
        var _a, _b, _c, _d;
        e.stopImmediatePropagation();
        if ((_a = $qs("#pp-".concat(modalName, "-existing-save"))) === null || _a === void 0 ? void 0 : _a.hasAttribute('disabled')) {
            closeSlideUpView(modalName);
            ...
            (_b = $qs("#pp-".concat(modalName, "-cancel .exit-back-btn"))) === null || _b === void 0 ? void 0 : _b.removeEventListener('click', cancelAndClose);
            self.removeEventListener('resize', handleResponsiveness);
        }
        else {
            if (confirm('Close without saving changes?')) {
                ...
                closeSlideUpView(modalName);
                backgroundElement === null || backgroundElement === void 0 ? void 0 : backgroundElement.removeEventListener('click', cancelAndClose);
                (_c = $qs("#pp-".concat(modalName, "-cancel .exit-back-btn"))) === null || _c === void 0 ? void 0 : _c.removeEventListener('click', cancelAndClose);
                self.removeEventListener('resize', handleResponsiveness);
                renderCustomerFields(PeachPayCustomer.data());
                (_d = $qs("#pp-".concat(modalName, "-existing-save"))) === null || _d === void 0 ? void 0 : _d.setAttribute('disabled', '');
                store.dispatch(stopModalLoading());
            }
        }
    };
    ...
    if (modalName === 'ship-to') {
        ...
        (_d = $qs("#pp-".concat(modalName, "-cancel .exit-back-btn"))) === null || _d === void 0 ? void 0 : _d.addEventListener('click', tapToClose);
    }
    if (modalName === 'cart') {
        var dropDown = $qs("#pp-dropdown".concat(Environment.modalUI.page() === 'returning' ? '' : '-new'));
...
function checkRequiredFields() {
    ...
    if (shouldCheckInfoForm) {
        ...
        var formID = modalPage === 'info' ? '.pp-info-form-new' : modalPage === 'returning' ? '.pp-info-form-returning' : '#pp-different-shipping-details';
...
function initModal(message) {
    ...
    (_d = $qs('#pp-continue-to-payment')) === null || _d === void 0 ? void 0 : _d.addEventListener('click', continueToPayment);
    (_e = $qs('#pp-continue-to-payment-mobile')) === null || _e === void 0 ? void 0 : _e.addEventListener('click', continueToPayment);
}
...
function centerModal() {
    ...
    if (modal && ppContainer) {
        var minHeight = Math.min(window.innerHeight, document.documentElement.clientHeight);
        if (document.body.scrollHeight <= minHeight) {
            if (window.matchMedia('(max-width: 900px)').matches) {
                modal.style.height = "".concat(minHeight, "px");
                ppContainer.style.removeProperty('height');
            }
            else {
                ppContainer.style.height = '100vh';
            }
        }
        else {
            ppContainer.style.removeProperty('height');
...
function returningInfoFormSaveClicked() {
    var _a, _b, _c, _d, _e, _f;
    var infoFormValidity = (_b = (_a = $qs('.pp-info-form-returning')) === null || _a === void 0 ? void 0 : _a.checkValidity()) !== null && _b !== void 0 ? _b : false;
    if (!infoFormValidity) {
        (_c = $qs('.pp-info-form-returning')) === null || _c === void 0 ? void 0 : _c.reportValidity();
        (_d = $qs('#pp-ship-to-existing-save')) === null || _d === void 0 ? void 0 : _d.setAttribute('disabled', '');
        return;
    }
    store.dispatch(startModalLoading());
    setTimeout(function () {
    ...
    (_e = $qs('#pp-ship-to-existing-save')) === null || _e === void 0 ? void 0 : _e.setAttribute('disabled', '');
    (_f = $qs('#pp-ship-to-existing-save')) === null || _f === void 0 ? void 0 : _f.removeEventListener('click', returningInfoFormSaveClicked);
...
function initShippingEvents() {
    ...
    (_d = $qs('.pp-info-form-new')) === null || _d === void 0 ? void 0 : _d.addEventListener('submit', function (event) { return __awaiter(_this, void 0, void 0, function () {
        var isValidAddress;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function validateAddress() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, fetchHostWindowData('pp-validate-billing-address', __assign(__assign(__assign({}, PeachPayCustomer.wcBillingAddress()), PeachPayCustomer.wcShippingAddress()), { ship_to_different_address: Environment.modalUI.page() !== 'info' && PeachPayCustomer.shipToDifferentAddress() }))];
                case 1: return [2, _a.sent()];
            }
        });
    });
...
function validateAddress1(address) {
    ...
    var countryLocaleRuleBilling = (_e = (_d = (_c = GLOBAL.phpData) === null || _c === void 0 ? void 0 : _c.wc_location_info) === null || _d === void 0 ? void 0 : _d.country_locale_data[PeachPayCustomer.billing.country()]) === null || _e === void 0 ? void 0 : _e.state;
    var countryLocaleRuleShipping = (_h = (_g = (_f = GLOBAL.phpData) === null || _f === void 0 ? void 0 : _f.wc_location_info) === null || _g === void 0 ? void 0 : _g.country_locale_data[PeachPayCustomer.shipping.country()]) === null || _h === void 0 ? void 0 : _h.state;
    var billingFields = (_j = GLOBAL.phpData) === null || _j === void 0 ? void 0 : _j.billing_fields;
    var billingFieldsOrder = (_k = GLOBAL.phpData) === null || _k === void 0 ? void 0 : _k.billing_fields_order;
    ...
    if (billingFields != null && billingFieldsOrder != null) {
        for (var i = 0; i < billingFieldsOrder.length; i++) {
            ...
            if (field.field_enable === 'yes' && field.field_required === 'yes' && isRequiredField(field.field_name, billingFields, countryLocaleRuleBilling)) {
    ...
    if (isOpenShippingChecked && shippingFields != null && shippingFieldsOrder != null) {
        for (var i1 = 0; i1 < shippingFieldsOrder.length; i1++) {
            ...
            if (field1.field_enable === 'yes' && field1.field_required === 'yes' && isRequiredField(field1.field_name, shippingFields, countryLocaleRuleShipping)) {
    ...
    for (var _i = 0, _l = Object.entries(address); _i < _l.length; _i++) {
...
function buildQuantityChanger(showImage, item) {
    ...
    var quantityChanger = "\n\t<div class=\"quantityChanger ".concat(showImage ? 'pp-qty-changer-with-img' : '', "\">\n\t\t<button type=\"button\" class=\"hide decrease-qty qty-btn ").concat(cartItemQuantity(item) <= 1 ? 'scroll-end' : '', "\" data-qid=\"").concat(item.item_key, "\">\n\t\t\t<img src=\"img/qty-minus.svg\">\n\t\t</button>\n\t\t<form onSubmit=\"return false;\" class=\"mb-0\">\n\t\t\t<input type=\"number\" min=\"0\" max=\"").concat(item.stock_qty ? item.stock_qty : '', "\" class=\"qty-fs\" value=\"").concat(cartItemQuantity(item), "\" data-qid=\"").concat(item.item_key, "\" required style=\"width: ").concat(width, "ch;\"/>\n\t\t</form>\n\t\t<button type=\"button\" class=\"hide increase-qty qty-btn ").concat(item.stock_qty && cartItemQuantity(item) >= item.stock_qty ? 'scroll-end' : '', "\" data-qid=\"").concat(item.item_key, "\">\n\t\t\t<img src=\"img/qty-plus.svg\">\n\t\t</button>\n\t</div>");
    return showQuantityChanger ? quantityChanger : quantityNumber;
}
function displayQuantityChangerUI() {
    $qsAll('.quantityChanger', function ($element) { return $element.addEventListener('mouseenter', function (event) {
        var $children = event.target.children;
        var _loop_7 = function (i) {
            var child = $children[i];
            child.classList.contains('qty-btn') ? setTimeout(function () {
    ...
    $qsAll('.quantityChanger', function ($element) { return $element.addEventListener('mouseleave', function (event) {
        var $children = event.target.children;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 8: return [4, context.service.createStripeIntent('payment', orderResponse, {
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (error_6 instanceof Error) {
                        captureSentryException(new Error("Google Pay/Apple Pay failed to initilize on ".concat(location.hostname, ". Error: ").concat(error_6.message)));
                    }
                    return [3, 3];
                case 3: return [2];
            }
...
function initStripePaymentProvider(message, orderService, pluginCapabilities) {
    ...
    var stripePublicKey = Environment.isTestOrDevSite() ? STRIPE_TEST_PK : STRIPE_LIVE_PK;
    var peachpayStripeOptions = buildStripeOptions(message, true);
    var peachpayStripe = Stripe(stripePublicKey, peachpayStripeOptions);
    var connectStripeOptions = buildStripeOptions(message, false);
    var connectStripe = Stripe(stripePublicKey, connectStripeOptions);
    var elements = peachpayStripe.elements();
    var context = {
    ...
    var capabilities = pluginCapabilities.stripe.account;
    var paymentMethods = setupStripeMethods(capabilities);
                ...
                case 0:
                    ...
                    return [4, fetch("".concat(Environment.apiURL(), "api/v1/stripe/payment-intent/cancel"), {
                            ...
                            body: JSON.stringify({
                                ...
                                transaction: {
                                    stripe: {
                                        connect_id: stripeContext.service.getStripeConnectId(),
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 6:
                    ...
                    store.dispatch(stopModalLoading());
                    return [2];
                case 7: return [4, createStripeIntent(DefaultCart.total() === 0 ? 'setup' : 'payment', orderResponse, {
                ...
                case 15:
                    ...
                    intermediateURL = buildRedirectStateURL(successURL, (_c = (_b = window.top) === null || _b === void 0 ? void 0 : _b.location.href) !== null && _c !== void 0 ? _c : '');
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    ...
                    store.dispatch(stopModalLoading());
                    return [2];
                case 4: return [4, createStripeIntent(DefaultCart.total() === 0 ? 'setup' : 'payment', orderResponse, {
                        transactionId: (_a = transaction === null || transaction === void 0 ? void 0 : transaction.getId()) !== null && _a !== void 0 ? _a : '',
...
function createStripeIntent(type, order, options) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
    ...
    [
        ...
        if (scrollEl) {
            scrollEl.addEventListener('scroll', function () {
                ...
                fadeAdjuster(scrollElName, scrollEl.scrollLeft === 0, Math.round(scrollEl.offsetWidth + scrollEl.scrollLeft) >= scrollEl.scrollWidth);
            });
        }
    });
    var previousCurrencyData = '';
...
function renderRecommendedProductsMiniSlider(products, title) {
    ...
    variationFieldsUI();
    initQuantityChangerEvent();
    for (var _e = 0, _f = $qsAll('.pp-js-add-btn'); _e < _f.length; _e++) {
        var addBtn = _f[_e];
...
function fillInAddress(section) {
    ...
    var formIdentifier = section === 'billing' ? '.pp-info-form' : '#pp-different-shipping-details';
    if (countryField) {
...
function renderSquareButtonDisplay(provider, page, loadingMode, cartTotal) {
    if (provider === 'square' && (page === 'payment' || page === 'returning') && cartTotal > 0) {
        ...
        $qsAll('.square-btn-container', function ($element) { return $element.classList.add('hide'); });
    }
    if (provider === 'square' && (page === 'payment' || page === 'returning') && loadingMode !== 'loading' && cartTotal > 0) {
...
function initSquareCardMethod() {
    ...
    return {
        ...
        tokenize: function (context, transaction) {
            return __awaiter(this, void 0, void 0, function () {
                var payments, cardElement, _a, status, token, response, error_15;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            payments = context.payments;
                        ...
                        case 1:
                            ...
                            if (status !== 'OK') {
                                transaction.update({
                                    paymentStatus: 'creationfailed',
                                    note: 'Square tokenizing card failed with status: ' + status
                                });
                                return [2, null];
                            }
                            _b.label = 2;
                        case 2:
                            _b.trys.push([2, 4, , 5]);
                            return [4, payments.verifyBuyer(token, {
                                    intent: 'CHARGE',
                        ...
                        case 4:
                            ...
                            transaction.update({
                                paymentStatus: 'creationfailed',
                                note: "Verifying Square buyer failed with error: ".concat(error_15)
                            });
                            return [2, [
                                    token,
                                    ''
...
var SQUARE_PRODUCTION_API = 'https://web.squarecdn.com/v1/square.js';
var SQUARE_SANDBOX_API = 'https://sandbox.web.squarecdn.com/v1/square.js';
function initSquarePaymentProvider(orderService, pluginCapabilities) {
    ...
    var scriptURL = Environment.isTestOrDevSite() ? SQUARE_SANDBOX_API : SQUARE_PRODUCTION_API;
    loadScript(scriptURL, 'Square', function () {
        var _a, _b, _c, _d;
        var applicationId = (_a = pluginCapabilities === null || pluginCapabilities === void 0 ? void 0 : pluginCapabilities.square.config.application_id) !== null && _a !== void 0 ? _a : '';
        var locationId = (_d = (_c = (_b = pluginCapabilities === null || pluginCapabilities === void 0 ? void 0 : pluginCapabilities.square) === null || _b === void 0 ? void 0 : _b.account) === null || _c === void 0 ? void 0 : _c.location_id) !== null && _d !== void 0 ? _d : '';
        var payments = Square.payments(applicationId, locationId);
        var context = {
            Square: Square,
            payments: payments
        };
        var paymentMethods = setupSquareMethods();
        activateSquareMethods(context, paymentMethods, orderService);
        setupSquareButton();
    });
}
function setupSquareMethods() {
    var paymentMethods = {};
...
function squarePaymentFlow(context, method, orderService) {
    return __awaiter(this, void 0, void 0, function () {
        var transaction, tokenizeResult, sourceId, verificationToken, order, payment, successURL;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store.dispatch(startModalProcessing());
                ...
                case 1:
                    transaction = _a.sent();
                    return [4, method.tokenize(context, transaction)];
                case 2:
                    tokenizeResult = _a.sent();
                    if (!!tokenizeResult) return [3, 4];
                    return [4, (transaction === null || transaction === void 0 ? void 0 : transaction.complete())];
                case 3:
                    _a.sent();
                    store.dispatch(stopModalLoading());
                    return [2];
                case 4:
                    sourceId = tokenizeResult[0], verificationToken = tokenizeResult[1];
                    return [4, orderService.placeOrder(transaction)];
                case 5:
                    order = _a.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    transaction === null || transaction === void 0 ? void 0 : transaction.update({
                        paymentStatus: 'failed',
                        note: "Unknown error creating Square paymente :: ".concat(JSON.stringify(error_16))
                    });
                    return [2, {
                            success: false
                        }];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    initStripePaymentProvider(message, orderService, pluginCapabilities);
