...
function checkRequiredFields() {
    ...
    if (Environment.customer.existing()) {
        ...
        (_e = $qs('#pp-returning-customer-store-account-info-form')) === null || _e === void 0 ? void 0 : _e.reportValidity();
        var returningAccountFormValidity = (_g = (_f = $qs('#pp-returning-customer-store-account-info-form')) === null || _f === void 0 ? void 0 : _f.checkValidity()) !== null && _g !== void 0 ? _g : true;
        var existingAdditionalFieldsFormValidity = (_j = (_h = $qs('#additional-fields-existing')) === null || _h === void 0 ? void 0 : _h.checkValidity()) !== null && _j !== void 0 ? _j : false;
        return returningAccountFormValidity && existingAdditionalFieldsFormValidity;
    }
    (_k = $qs('#additional-fields-new')) === null || _k === void 0 ? void 0 : _k.reportValidity();
    (_l = $qs('#pp-new-customer-store-account-info-form')) === null || _l === void 0 ? void 0 : _l.reportValidity();
    var newAccountFormValidity = (_o = (_m = $qs('#pp-new-customer-store-account-info-form')) === null || _m === void 0 ? void 0 : _m.checkValidity()) !== null && _o !== void 0 ? _o : true;
    var newAdditionalFieldsFormValidity = (_q = (_p = $qs('#additional-fields-new')) === null || _p === void 0 ? void 0 : _p.checkValidity()) !== null && _q !== void 0 ? _q : false;
    return newAccountFormValidity && newAdditionalFieldsFormValidity;
}
...
function formGenerator(fieldData, fieldOrder, formIdDifferentiator) {
...
function syncCustomerFieldChanges() {
    ...
    var refreshCurrencySwitchFeature = formFields.shipping_country !== PeachPayCustomer.country();
...
function setEmailFieldDefaultValues(idDifferentiator) {
    ...
    if ($accountLoginEmailField) {
        $accountLoginEmailField.value = PeachPayCustomer.email();
    }
    if ($accountRegistrationEmailField) {
        $accountRegistrationEmailField.value = PeachPayCustomer.email();
    }
}
...
function generateMerchantCustomerAccountForm(idDifferentiator) {
    ...
    return formGenerator(fieldData, fieldOrder, idDifferentiator + '-store-account');
}
...
function renderOrderHeader(cart) {
    ...
    if (cartIsVirtual(cart)) {
        ...
        for (var _f = 0, _g = $qsAll('.show-for-virtual-carts'); _f < _g.length; _f++) {
            var $element1 = _g[_f];
            if (getFullName(PeachPayCustomer.data()).replace(/\s/g, '') === '' && getFullAddress(PeachPayCustomer.data()).replace(/\s/g, '') === '') {
                return;
            }
    ...
    for (var i = cart.length - 1; i >= 0; i--) {
        ...
        if (linkedProducts) {
            ...
            for (var _i = 0, linkedProducts_1 = linkedProducts; _i < linkedProducts_1.length; _i++) {
                ...
                if (!hasSameLinkedProduct(linkedItem.id)) {
...
function removeLinkedProduct(cart) {
    var _a, _b, _c, _d, _e;
    for (var _i = 0, _f = $qsAll('.pp-product-body'); _i < _f.length; _i++) {
