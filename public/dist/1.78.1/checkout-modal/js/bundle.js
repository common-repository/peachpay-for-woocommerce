...
function handleTokenResult(result, transaction) {
...
function initSquareCardMethod(account) {
    ...
    return {
        ...
        tokenize: function (context, transaction) {
            return __awaiter(this, void 0, void 0, function () {
                var payments, cardElement, tokenResult, token, response, error_15;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            payments = context.payments;
                        ...
                        case 1:
                            tokenResult = _a.sent();
                            token = handleTokenResult(tokenResult, transaction);
                            if (!token) {
                                return [2, null];
                            }
                            _a.label = 2;
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4, payments.verifyBuyer(token !== null && token !== void 0 ? token : '', {
                                    intent: 'CHARGE',
...
function initSquareGooglePayMethod(account) {
    ...
    return {
        ...
        tokenize: function (_, transaction) {
            return __awaiter(this, void 0, void 0, function () {
                var result, token;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!gpay) {
                                transaction.update({
                                    paymentStatus: 'creationfailed',
                                    note: 'Google Pay instance is null.'
                                });
                                return [2, null];
                            }
                        ...
                        case 1:
                            result = _a.sent();
                            token = handleTokenResult(result, transaction);
                            if (!token) {
                                return [2, null];
                            }
                            return [2, [
...
function initSquareApplePayMethod(account) {
    ...
    return {
        ...
        tokenize: function (_context, transaction) {
            return __awaiter(this, void 0, void 0, function () {
                var result, token;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!apay) {
                                transaction.update({
                                    paymentStatus: 'creationfailed',
                                    note: 'Apple Pay instance is null.'
                                });
                                return [2, null];
                            }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    transaction === null || transaction === void 0 ? void 0 : transaction.update({
                        paymentStatus: 'failed',
                        note: "Unknown error creating Square payment :: ".concat(JSON.stringify(error_16))
                    });
                    return [2, {
                            success: false
                        }];
