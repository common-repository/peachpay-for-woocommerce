...
var peachpayi18n = {
    ...
    "de-DE": {
        ...
        "Different shipping details?": "Abweichende Versandadresse?",
        "Edit": "Bearbeiten",
        "Email": "Email",
...
function initStripeCardMethod() {
    ...
    return {
        ...
        setup: function (context, clientSecret, options) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (setupIntent.status === 'succeeded' || setupIntent.status === 'requires_capture') {
                            if (window.top) {
                                clearLocalSession();
                                window.top.location = options.directURL;
                            }
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 3:
                    ...
                    return [4, context.service.createStripeIntent('payment', orderResponse, {
...
function newPaymentMethodFlow(context, providerMethod, orderService) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var paymentMethod, orderResponse, stripeIntentResponse, savedDetails, successURL, intermediateURL, handlePaymentFlowError, _c, unhandledError, message, _d, unhandledError1, message1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    return [4, createStripeIntent(DefaultCart.total() === 0 ? 'setup' : 'payment', orderResponse, {
                            paymentMethodId: paymentMethod.id,
                            paymentMethodType: PaymentConfiguration.selectedProviderMethod()
                        })];
                case 3:
                    stripeIntentResponse = _e.sent();
                    if (!!stripeIntentResponse.success) return [3, 8];
                    store.dispatch(stopModalLoading());
                    if (!(stripeIntentResponse.message && providerMethod.displayPaymentIntentError)) return [3, 5];
                    providerMethod.displayPaymentIntentError(stripeIntentResponse.message);
                    return [4, orderService.addOrderNote(orderResponse, 'Payment attempt failed. Reason: ' + stripeIntentResponse.message)];
                case 4:
                    _e.sent();
                    return [3, 7];
                ...
                case 8:
                    ...
                    handlePaymentFlowError = function (confirmFailureMessage, sentryError) {
                        store.dispatch(stopModalLoading());
                        store.dispatch(setOrderError(getLocaleText('Sorry, something went wrong. Please refresh the page and try again.')));
                    ...
                    if (!(stripeIntentResponse.data.type === 'setup')) return [3, 10];
                    if (!providerMethod.setup) {
                        handlePaymentFlowError(undefined, new Error('providerMethod for stripe SetupIntent does not support SetupIntent.'));
                        return [2];
                    }
                    return [4, providerMethod.setup(context, stripeIntentResponse.data.stripe.client_secret, {
                            intermediateURL: intermediateURL,
                            directURL: orderResponse.redirect
                        })];
                case 9:
                    _c = _e.sent(), unhandledError = _c[0], message = _c[1];
                    if (unhandledError) {
                        handlePaymentFlowError(message, new Error("Confirming setup intent failed for new payment flow."));
                    }
                    return [2];
                case 10: return [4, providerMethod.confirm(context, stripeIntentResponse.data.stripe.client_secret, {
                        intermediateURL: intermediateURL,
                        directURL: orderResponse.redirect
                    })];
                case 11:
                    _d = _e.sent(), unhandledError1 = _d[0], message1 = _d[1];
                    if (unhandledError1) {
                        handlePaymentFlowError(message1, new Error("Confirming payment intent failed for new payment flow."));
                        return [2];
                    }
                    return [2];
            }
...
function existingPaymentMethodFlow(context, providerMethod, orderService) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var savedPaymentMethod, orderResponse, stripeIntentResponse, successURL, intermediateURL, handlePaymentFlowError, _c, unhandledError, message, _d, unhandledError1, message1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                ...
                case 2:
                    stripeIntentResponse = _e.sent();
                    if (!!stripeIntentResponse.success) return [3, 7];
                    store.dispatch(stopModalLoading());
                    if (!(stripeIntentResponse.message && providerMethod.displayPaymentIntentError)) return [3, 4];
                    return [4, orderService.addOrderNote(orderResponse, 'Payment attempt failed. Reason: ' + stripeIntentResponse.message)];
                case 3:
                    _e.sent();
                    providerMethod.displayPaymentIntentError(stripeIntentResponse.message);
                ...
                case 7:
                    ...
                    if (!(stripeIntentResponse.data.type === 'setup')) return [3, 9];
                    if (!providerMethod.setup) {
                        handlePaymentFlowError(undefined, new Error('providerMethod for stripe SetupIntent does not support SetupIntent.'));
                        return [2];
                    }
                ...
                case 8:
                    _c = _e.sent(), unhandledError = _c[0], message = _c[1];
                    if (unhandledError) {
                        handlePaymentFlowError(message, new Error("Confirming setup intent failed for existing payment flow."));
                    }
                    return [2];
                case 9: return [4, providerMethod.confirm(context, stripeIntentResponse.data.stripe.client_secret, {
                        intermediateURL: intermediateURL,
                        directURL: orderResponse.redirect
                    })];
                case 10:
                    _d = _e.sent(), unhandledError1 = _d[0], message1 = _d[1];
                    if (unhandledError1) {
                        handlePaymentFlowError(message1, new Error("Confirming payment intent failed for existing payment flow."));
                        return [2];
                    }
                    return [2];
            }
    ...
    onWindowMessage('init', function (message) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4, initNoPaymentProviders()];
                case 3:
                    _a.sent();
