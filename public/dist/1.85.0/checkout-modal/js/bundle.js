...
(function (DispatchActionType) {
    ...
    DispatchActionType["AVAILABLE_GATEWAYS"] = "AVAILABLE_GATEWAYS";
...
function paymentConfigurationReducer(state, action) {
    switch (action.type) {
        ...
        case DispatchActionType.AVAILABLE_GATEWAYS:
            {
                var payload2 = action.payload;
                return __assign(__assign({}, state), { availableGateways: payload2 });
            }
        default:
            return __assign({}, state);
    }
...
var updateAvailableGateways = createDispatchUpdate(DispatchActionType.AVAILABLE_GATEWAYS);
...
var PaymentConfiguration = {
    ...
    eligibleMethod: function (providerKey, methodKey, index) {
        ...
        if (method.supports) {
            ...
            if (!store.getState().paymentConfiguration.availableGateways.includes(method.gateway)) {
                return false;
            }
        }
        return true;
    ...
    getMethodDefaultCurrency: function (providerKey, methodKey) {
        ...
        return (_b = (_a = method.supports) === null || _a === void 0 ? void 0 : _a.defaultCurrency) !== null && _b !== void 0 ? _b : null;
    },
    methodSupportsCurrentCurrency: function (providerKey, methodKey) {
        ...
        var currencyCode = MerchantConfiguration.currency.code();
        if (!((_a = method.supports) === null || _a === void 0 ? void 0 : _a.currencies.includes(currencyCode)) && !((_b = method.supports) === null || _b === void 0 ? void 0 : _b.currencies.includes('ALL'))) {
            return false;
        }
        return true;
    },
...
function placeWCOrder(transaction, extraFormData) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var gateway, requestMessage, currentPage, loginType, isRegistration, loginType1, isRegistration1, _d, validAddress, errorMessage, response, message;
            ...
            switch (_e.label) {
                ...
                case 1:
                    ...
                    if (response.result === 'failure') {
                        ...
                        if (gateway === 'peachpay_paypal' || gateway === 'peachpay_amazon' || gateway === 'peachpay_authnet') {
                            transaction === null || transaction === void 0 ? void 0 : transaction.update({
                                orderStatus: 'creationfailed',
                                order: response,
                                note: message
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        if (((_d = method === null || method === void 0 ? void 0 : method.supports) === null || _d === void 0 ? void 0 : _d.defaultCurrency) && !PaymentConfiguration.methodSupportsCurrentCurrency(providerKey, methodKey)) {
                            event_1 = new CustomEvent('pp-change-currency', {
                                detail: (_e = method === null || method === void 0 ? void 0 : method.supports) === null || _e === void 0 ? void 0 : _e.defaultCurrency
                            });
...
function generateMerchantCustomerAccountForm(idDifferentiator) {
    ...
    if (shouldShowMerchantCustomerAccountLoginTypeCheckboxes()) {
        ...
        header = "<div class=\"pp-tooltip\">\n\t\t\t\t\t<span class=\"pp-title pp-account-title\">".concat(label, "</span>\n\t\t\t\t\t<span class=\"pp-question-mark\"><img class=\"pp-pm-help-badge\" src=\"img/property-help.svg\"><div class=\"pp-tooltip-popup-point\"></div></span>\n\t\t\t\t\t<span class=\"pp-tooltip-popup\">").concat(accountLoginExplanation, "</span>\n\t\t\t\t</div>");
    }
    else {
    ...
    var init = function (stripe) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    if (!(result === null || result === void 0 ? void 0 : result.applePay)) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (((_a = orderResponse === null || orderResponse === void 0 ? void 0 : orderResponse.details) === null || _a === void 0 ? void 0 : _a.total) === '0') {
                        orderResponse.details.total = String(DefaultCart.total());
                    }
                    if (!orderResponse.details) {
                        orderResponse.details = {
                            id: String(orderResponse.order_id),
                            order_key: orderKeyFromURLParams(orderResponse.redirect),
                            total: String(DefaultCart.total())
                        };
                    }
                    orderResponse.details.billing = {
                        first_name: PeachPayCustomer.billing.firstName(),
                        last_name: PeachPayCustomer.billing.lastName()
                    };
                    orderResponse.details.currency = MerchantConfiguration.currency.code();
                    return [4, (transaction === null || transaction === void 0 ? void 0 : transaction.complete({
                            order: orderResponse,
...
function initCODSupport(orderService) {
    ...
    addButtonListener(getCODMethodConfiguration().slug, function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, orderService.startTransaction(getCODMethodConfiguration().gateway)];
                case 1:
                    transaction = _a.sent();
...
function initChequeSupport(orderService) {
    ...
    addButtonListener(getChequeMethodConfiguration().slug, function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, orderService.startTransaction(getChequeMethodConfiguration().gateway)];
                case 1:
                    transaction = _a.sent();
                    return [4, defaultOrderFlow(orderService, transaction)];
                case 2:
...
function initBacsSupport(orderService) {
    ...
    addButtonListener(getBacsMethodConfiguration().slug, function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, orderService.startTransaction(getBacsMethodConfiguration().gateway)];
                case 1:
                    transaction = _a.sent();
                    return [4, defaultOrderFlow(orderService, transaction)];
                case 2:
...
function orderKeyFromURLParams(url) {
    var _a;
    return (_a = new URLSearchParams(url.split('?')[1]).get('key')) !== null && _a !== void 0 ? _a : '';
}
