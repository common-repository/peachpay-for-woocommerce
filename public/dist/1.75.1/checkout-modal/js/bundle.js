...
function checkRequiredFields() {
    ...
    if (shouldCheckInfoForm) {
        var modalPage = Environment.modalUI.page() === 'info' || Environment.modalUI.page() === 'returning' ? 'info' : 'shipping';
        var formID = modalPage === 'info' ? '#pp-info-form' : '#pp-different-shipping-details';
    ...
    store.subscribe(function () {
        ...
        if (Environment.modalUI.page() === 'info' || Environment.modalUI.page() === 'shipping') {
            if (Carts.virtual() && Feature.enabled(FeatureFlag.VIRTUAL_PRODUCT_FIELDS)) {
                ...
                $qs('#pp-shipping-options', function ($element) { return $element.classList.add('hide'); });
                (_o = $qs('#shipping-details fieldset')) === null || _o === void 0 ? void 0 : _o.setAttribute('disabled', '');
...
function renderCorrectProvinceField(section, fieldData) {
    ...
    if (merchantShipping) {
        var info = section === 'billing' ? PeachPayCustomer.billing : PeachPayCustomer.shipping;
        var _g = stateProvinceOrCounty(info.country()), defaultOption_1 = _g[0], label_1 = _g[1];
        ...
        var fieldInfo_1 = (_d = (_c = (_b = GLOBAL.phpData) === null || _b === void 0 ? void 0 : _b.wc_location_info) === null || _c === void 0 ? void 0 : _c.country_locale_data[info.country()]) === null || _d === void 0 ? void 0 : _d.state;
        if (stateOrProvinceOptions_1 && Object.keys(stateOrProvinceOptions_1).length > 0) {
            $qs("#".concat(stateId), function ($stateOrProvincesSelect) {
                ...
                $stateOrProvincesSelect.required = isRequiredField("".concat(section, "_state"), fieldData, fieldInfo_1);
            ...
            (_e = $qs("label[for=\"".concat(provinceId, "\"]"))) === null || _e === void 0 ? void 0 : _e.classList.add('hide');
        }
        else {
            $qs("#".concat(stateId), function ($stateOrProvincesSelect) {
                var _a;
            ...
            (_f = $qs("label[for=\"".concat(stateId, "\"]"))) === null || _f === void 0 ? void 0 : _f.classList.add('hide');
            $qs("#".concat(provinceId), function ($stateOrProvincesText) {
                ...
                $stateOrProvincesText.required = isRequiredField("".concat(section, "_state"), fieldData, fieldInfo_1);
            });
...
function renderCustomerHeader(customer) {
    ...
    $qsAll('.pp-address', function ($element) { return $element.innerHTML = shortAddress; });
    $qsAll('.pp-address-hidden', function ($element) { return $element.innerHTML = fullAddress; });
    $qs('#pp-return-address-line', function ($elemnt) { return $elemnt.innerHTML = fullAddress; });
}
...
function validateAddress() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, fetchHostWindowData('pp-validate-billing-address', __assign(__assign(__assign({}, PeachPayCustomer.wcBillingAddress()), PeachPayCustomer.wcShippingAddress()), { ship_to_different_address: PeachPayCustomer.shipToDifferentAddress() }))];
                case 1: return [2, _a.sent()];
            }
        });
    });
...
function validateAddress1(address) {
    ...
    var _loop_3 = function (key, value) {
        if (requiredFields.includes(key)) {
            if (key === 'billing_state' && shippingFields !== undefined && !isRequiredField(key, shippingFields, countryLocaleRuleBilling)) {
                return "continue";
            }
            if (key === 'shipping_state' && shippingFields !== undefined && !isRequiredField(key, shippingFields, countryLocaleRuleShipping)) {
                return "continue";
            }
    ...
    if (requiredFields.includes('billing_state') && shippingFields !== undefined && !isRequiredField(requiredFields[0], shippingFields, countryLocaleRuleBilling)) {
        requiredFields.shift();
    }
    if (requiredFields.includes('shipping_state') && shippingFields !== undefined && !isRequiredField(requiredFields[0], shippingFields, countryLocaleRuleShipping)) {
        requiredFields.shift();
    }
...
function renderBundleItem(item) {
    ...
    var $imgDiv = getImgQtyDiv(item, true);
...
function renderCartItem(itemBundle) {
    ...
    var $imgQtyDiv = getImgQtyDiv(item, itemBundle.length > 1);
    ...
    if (itemBundle.length === 1) {
        var $quantityDiv = document.createElement('div');
        $quantityDiv.className = 'quantityChanger';
        $quantityDiv.innerHTML = buildQuantityChanger(item);
        $itemInfoContainer.appendChild($quantityDiv);
    }
...
function getImgQtyDiv(item, isBundle) {
    var _a, _b;
    ...
    if (!showImage && !showQuantityChanger) {
        ...
        $div.innerHTML += buildQuantityChanger(item, isBundle);
        return $div;
    }
    if (showImage) {
        if (item.is_part_of_bundle) {
    ...
    if (isBundle) {
        $div.innerHTML += buildQuantityChanger(item, true);
    }
    return $div;
}
function buildQuantityChanger(item, isBundle) {
    if (isBundle === void 0) { isBundle = false; }
    var showQuantityChanger = Feature.enabled(FeatureFlag.QUANTITY_CHANGER) && !item.is_part_of_bundle;
    var quantityNumber = !isBundle ? "<div class=\"pp-quantity-static\">".concat(getLocaleText('Quantity'), ": ").concat(cartItemQuantity(item)) : "<div class=\"pp-quantity-static\">".concat(cartItemQuantity(item), "x");
    ...
    return showQuantityChanger ? quantityChange : quantityNumber;
}
...
function centerModal() {
    ...
    if ((modal === null || modal === void 0 ? void 0 : modal.scrollHeight) && modal.scrollHeight <= window.innerHeight + 52) {
        if (window.matchMedia('(max-width: 900px)').matches) {
...
function renderCurrencySelector() {
    ...
    var $insertionLocationMobile = $qs('.pp-order-summary-mobile');
...
function handleStripePaymentRequestProcessPayment(request, context, orderService) {
    var _a, _b, _c, _d, _e, _f;
    return __awaiter(this, void 0, void 0, function () {
        var transaction, orderResponse, paymentIntentResponse, stripe, _g, error, paymentIntent, error1_1;
...
function initRelatedProducts() {
    ...
    store.subscribe(function () {
        ...
        var cartData = JSON.stringify(DefaultCart.contents());
        var currencyData = JSON.stringify(MerchantConfiguration.currency.configuration());
        if (Environment.plugin.pageType() === 'product' && relatedProducts && relatedProducts.length && relatedProductsTitle) {
            if (cartData !== previousCartData || currencyData !== previousCurrencyData) {
                previousCartData = cartData;
                previousCurrencyData = currencyData;
...
function initSquareCardMethod() {
    ...
    return {
        ...
        activate: function (context) { return __awaiter(_this, void 0, void 0, function () {
            var payments, squareCardOptions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        tokenize: function (context, transaction) {
            return __awaiter(this, void 0, void 0, function () {
                var payments, cardElement, _a, status, token, response, error_10;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            payments = context.payments;
                        ...
                        case 4:
                            ...
                            transaction.update({
                                paymentStatus: 'creationfailed',
                                note: "Verifying Square buyer failed with error: ".concat(error_10)
                            });
                            return [2, [
                                    token,
                                    ''
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    $qsAll('.square-btn', function ($button) { return $button.addEventListener('click', confirm); });
                    return [2];
            }
        });
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    transaction === null || transaction === void 0 ? void 0 : transaction.update({
                        paymentStatus: 'failed',
                        note: "Unknown error creating Square paymente :: ".concat(JSON.stringify(error_11))
                    });
                    return [2, {
                            success: false
                        }];
...
function initNoPaymentProviders() {
    placeNoPaymentMethod();
    store.subscribe(function () {
        renderNoPaymentOptions();
    });
}
function placeNoPaymentMethod() {
    $qsAll('.pay-button-container', function ($el) {
        var $message = "<div class=\"pp-no-payment-options hide\"> ".concat(getLocaleText('The merchant has not enabled any payment methods'), " <div>");
        $el.insertAdjacentHTML('beforeend', $message);
    });
}
function renderNoPaymentOptions() {
    if (!Feature.enabled(FeatureFlag.STRIPE) && !Feature.enabled(FeatureFlag.PAYPAL) && !Feature.enabled(FeatureFlag.BACS_PAYMENT) && !Feature.enabled(FeatureFlag.CHEQUE_PAYMENT) && !Feature.enabled(FeatureFlag.COD_PAYMENT) && !Feature.enabled(FeatureFlag.PURCHASE_ORDER)) {
        $qsAll('.pp-no-payment-options', function ($el) { return $el.classList.remove('hide'); });
    }
}
(function () {
    var _this = this;
