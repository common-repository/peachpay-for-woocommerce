...
function generateMainForm(message) {
    ...
    container.appendChild(formGenerator((_b = (_a = message.phpData) === null || _a === void 0 ? void 0 : _a.billing_fields) !== null && _b !== void 0 ? _b : [], (_d = (_c = message.phpData) === null || _c === void 0 ? void 0 : _c.billing_fields_order) !== null && _d !== void 0 ? _d : [], 'billing'));
...
(function (DispatchActionType) {
    ...
    DispatchActionType["PAYMENT_INITIALIZE_UI"] = "PAYMENT_INITIALIZE_UI";
...
function paymentConfigurationReducer(state, action) {
    switch (action.type) {
        ...
        case DispatchActionType.PAYMENT_INITIALIZE_UI:
    ...
    return {
        ...
        payload: {
            ...
            customer: {
                ...
                saveToBrowserSelected: (_d = options.customerSaveToBrowserSelected) !== null && _d !== void 0 ? _d : Environment.customer.saveToBrowserSelected()
            },
            plugin: {
...
var Environment = {
    ...
    customer: {
        ...
        saveToBrowserSelected: function () { return store.getState().environment.customer.saveToBrowserSelected; }
    },
    plugin: {
...
(function (FeatureFlag) {
    ...
    FeatureFlag["PURCHASE_ORDER"] = 'peachpay_purchase_order_gateway';
    ...
    FeatureFlag["AUTHNET"] = 'authnet_payment_method';
    FeatureFlag["TRANSACTION_THRESHOLDS"] = 'transaction_thresholds';
    FeatureFlag["SQUARE"] = 'peachpay_square_gateways';
    FeatureFlag["SQUARE_CARD"] = 'peachpay_square_card_gateway';
    FeatureFlag["SQUARE_APPLEPAY"] = 'peachpay_square_applepay_gateway';
    FeatureFlag["SQUARE_GOOGLEPAY"] = 'peachpay_square_googlepay_gateway';
    FeatureFlag["STRIPE_GATEWAYS"] = 'peachpay_stripe_gateways';
    FeatureFlag["STRIPE_CARD_GATEWAY"] = 'peachpay_stripe_card_gateway';
    FeatureFlag["STRIPE_GOOGLEPAY_GATEWAY"] = 'peachpay_stripe_googlepay_gateway';
    FeatureFlag["STRIPE_APPLEPAY_GATEWAY"] = 'peachpay_stripe_applepay_gateway';
    FeatureFlag["STRIPE_ACHDEBIT_GATEWAY"] = 'peachpay_stripe_achdebit_gateway';
    FeatureFlag["STRIPE_AFFIRM_GATEWAY"] = 'peachpay_stripe_affirm_gateway';
    FeatureFlag["STRIPE_AFTERPAY_GATEWAY"] = 'peachpay_stripe_afterpay_gateway';
    FeatureFlag["STRIPE_BANCONTACT_GATEWAY"] = 'peachpay_stripe_bancontact_gateway';
    FeatureFlag["STRIPE_EPS_GATEWAY"] = 'peachpay_stripe_eps_gateway';
    FeatureFlag["STRIPE_GIROPAY_GATEWAY"] = 'peachpay_stripe_giropay_gateway';
    FeatureFlag["STRIPE_IDEAL_GATEWAY"] = 'peachpay_stripe_ideal_gateway';
    FeatureFlag["STRIPE_KLARNA_GATEWAY"] = 'peachpay_stripe_klarna_gateway';
    FeatureFlag["STRIPE_P24_GATEWAY"] = 'peachpay_stripe_p24_gateway';
    FeatureFlag["STRIPE_SOFORT_GATEWAY"] = 'peachpay_stripe_sofort_gateway';
...
createDispatchUpdate(DispatchActionType.PEACHPAY_CUSTOMER_STRIPE_ID);
...
createDispatchUpdate(DispatchActionType.PEACHPAY_CUSTOMER_SHIPPING);
...
createDispatchUpdate(DispatchActionType.PEACHPAY_CUSTOMER_ADD_PAYMENT_METHOD);
...
var PeachPayCustomer = {
    ...
    billing: {
        ...
        country: function () { var _a; return store.getState().peachPayCustomer.form_fields.billing_country || ((_a = store.getState().merchantConfiguration.general.wcLocationInfoData) === null || _a === void 0 ? void 0 : _a.store_country) || ''; },
    ...
    for (var _i = 0, _a = Object.entries(fieldRecord); _i < _a.length; _i++) {
        ...
        if (div) {
            if (value === '' || value === 'unchecked') {
                ...
                if (options && value !== '') {
                    var searcher = new RegExp(value + ':([^;]*);');
                    var match = options.match(searcher);
                    if (match) {
                        value = match[1];
                    }
                }
...
function reduceOptionOrders(reduced, remaining) {
    if (remaining.length) {
        var newReduced = reduced + "".concat(remaining[0][0], ":").concat(remaining[0][1], ";");
        remaining.shift();
        return reduceOptionOrders(newReduced, remaining);
    }
    else {
        return reduced;
    }
...
function generateAdditionalFieldsPreview(fieldData) {
    var optionOrder = fieldData.option_order;
    ...
    if (optionOrder !== undefined) {
        optionOrderStr = reduceOptionOrders('', optionOrder);
    }
    return "<div class=\"pp-additional-preview\" name=\"".concat(fieldData.field_name, "\">\n\t\t<div class=\"pp-additional-preview-label").concat(fieldData.field_required ? ' required' : '', "\">").concat(fieldData.field_label + (fieldData.field_required ? '*' : ''), "</div>\n\t\t<div class=\"pp-additional-preview-value").concat(fieldData.field_required ? ' required' : '', " initial\"").concat(optionOrderStr !== '' && " data-options=\"".concat(optionOrderStr, "\""), ">").concat(fieldData.field_required ? 'Not yet filled out' : 'N/A', "</div>\n\t\t<div class=\"pp-fade-right\"></div>\n\t</div>");
}
...
function generateFields(fieldData, fieldOrder) {
    ...
    if (fieldOrder.length === 1) {
        ...
        if (newPageElement) {
            var fields_1 = '';
            fieldOrder.forEach(function (orderNumber, index) {
                var datum = fieldData[orderNumber];
...
function generateFieldElement(location1, fieldData, accordion) {
    ...
    var formLabelBuilder = function (location1, labelText) {
        if (!labelText) {
            labelText = fieldData.field_label + (fieldData.field_required ? '*' : !accordion ? ' (optional)' : '');
        }
        return "<label for=\"".concat(fieldData.field_name + location1, "\" class=\"pp-form-label\">\n\t\t\t").concat(labelText, "\n\t\t</label>");
    };
    var labelBuilder = function (location1, isAdditionalFieldOuterLabel) {
        return "<label ".concat(isAdditionalFieldOuterLabel && 'class="pp-additional-field-label" ', " for=\"").concat(fieldData.field_name + location1, "\">\n\t\t\t").concat(fieldData.field_label + (fieldData.field_required ? '*' : ''), "\n\t\t</label>");
    };
    var textAreaBuilder = function (location1) {
        var _a;
        var isTextArea = fieldData.type_list === 'text';
        var inner = "<".concat(isTextArea ? 'textarea' : 'input', " type=\"").concat(fieldData.type_list, "\"\n\t\t\tname=\"").concat(fieldData.field_name, "\"\n\t\t\tclass=\"extra-field\"\n\t\t\tid=\"").concat(fieldData.field_name).concat(location1, "\"\n\t\t\tplaceholder=\"").concat((_a = fieldData.field_placeholder) !== null && _a !== void 0 ? _a : ' ', "\"\n\t\t\t").concat(fieldData.field_default ? "value=\"".concat(fieldData.field_default, "\"") : '', "\n\t\t\t").concat(fieldData.field_required ? 'required' : '', ">").concat(isTextArea && '</textarea>');
        if (!accordion && location1 === '-new') {
            return "<div class=\"flex-col\">\n\t\t\t\t".concat(inner, "\n\t\t\t\t").concat(fieldData.field_label ? formLabelBuilder(location1) : '', "\n\t\t\t</div>");
        }
        else if (!accordion && location1 === '-existing') {
            return "<div class=\"flex-col\">\n\t\t\t\t".concat(fieldData.field_label ? labelBuilder(location1, true) : '', "\n\t\t\t\t<div class=\"flex-col\">\n\t\t\t\t\t").concat(inner, "\n\t\t\t\t\t").concat(fieldData.field_label ? formLabelBuilder(location1, 'Your answer') : '', "\n\t\t\t\t</div>\n\t\t\t</div>");
        }
        else {
...
var initializePrimaryPaymentMethodUI = createCustomDispatchUpdate(DispatchActionType.PAYMENT_INITIALIZE_UI, function () {
    var _a, _b, _c;
    var primaryMethods = [];
...
var PaymentConfiguration = {
    ...
    eligibleMethod: function (providerKey, methodKey, index) {
        ...
        if (cartsTotal > 0 && minimumTotal !== 'n/a' && !isNaN(parseFloat(minimumTotal)) && cartsTotal < parseFloat(minimumTotal)) {
            return false;
        }
        if (cartsTotal > 0 && parseFloat(maximumTotal) !== 0 && maximumTotal !== 'n/a' && !isNaN(parseFloat(maximumTotal)) && cartsTotal > parseFloat(maximumTotal)) {
            return false;
        }
    ...
    firstEligibleMethod: function () {
        ...
        else if (PaymentConfiguration.eligibleMethod('square', 'card')) {
            return {
                provider: 'square',
                method: 'card'
            };
    ...
    selectedMethodConfiguration: function () {
        ...
        var method = provider === null || provider === void 0 ? void 0 : provider.methods[PaymentConfiguration.selectedProviderMethod()];
        return method;
    },
...
function reactToMethodFiltering() {
    ...
    if (secondaryMethods.length) {
        for (var _i = 0, primaryMethods_1 = primaryMethods; _i < primaryMethods_1.length; _i++) {
            ...
            if (!method1) {
                store.dispatch(initializePrimaryPaymentMethodUI());
                return;
            }
        }
    }
...
function generateShippingForm(message) {
    ...
    var container = document.createElement('div');
    container.classList.add('flex', 'col', 'pp-form-rows-container');
    container.appendChild(formGenerator((_b = (_a = message.phpData) === null || _a === void 0 ? void 0 : _a.shipping_fields) !== null && _b !== void 0 ? _b : [], (_d = (_c = message.phpData) === null || _c === void 0 ? void 0 : _c.shipping_fields_order) !== null && _d !== void 0 ? _d : [], 'shipping'));
    return container;
}
...
function installCustomerFormFields(message) {
    ...
    var ppInfo = $qs('#pp-info');
    if (ppInfo) {
        ppInfo.insertBefore(form, ppInfo.firstChild);
    }
    var returningForm = initBillingFormReturning(message);
    var ppInfoExisting = $qs('#pp-info-form-returning .pp-form-rows-container');
    if (ppInfoExisting) {
        ppInfoExisting.insertBefore(returningForm, ppInfoExisting.firstChild);
    }
}
function installCustomerBillingFields(message) {
    var _a;
    var newForm = generateShippingForm(message);
    (_a = $qs('#shipping-details fieldset')) === null || _a === void 0 ? void 0 : _a.appendChild(newForm);
}
            ...
            switch (_b.label) {
                case 0:
                    requestData = initial ? {
                        ...
                        order: {
                            payment_method: (_a = PaymentConfiguration.selectedMethodConfiguration()) === null || _a === void 0 ? void 0 : _a.gateway,
...
function isEnabledField(name, fieldData, fieldInfo) {
    var fieldDataInfo = false;
    for (var orderNumber in fieldData) {
        if (name === fieldData[orderNumber].field_name) {
            fieldDataInfo = fieldData[orderNumber].field_enable ? true : false;
        }
    }
    var countryLocaleRuleNotHidden = true;
    if (fieldInfo) {
        if (fieldInfo.hidden === undefined) {
            countryLocaleRuleNotHidden = true;
        }
        else {
            countryLocaleRuleNotHidden = !(fieldInfo === null || fieldInfo === void 0 ? void 0 : fieldInfo.hidden);
        }
    }
    return fieldDataInfo && countryLocaleRuleNotHidden;
}
function isShortAddressEmpty(section) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
    var defaultShortAddress = [
        section + '_postcode',
        section + '_city',
        section + '_state',
        section + '_country'
    ...
    var fields = section === 'billing' ? (_a = GLOBAL.phpData) === null || _a === void 0 ? void 0 : _a.billing_fields : (_b = GLOBAL.phpData) === null || _b === void 0 ? void 0 : _b.shipping_fields;
    var fieldPostalCodeInfo = (_e = (_d = (_c = GLOBAL.phpData) === null || _c === void 0 ? void 0 : _c.wc_location_info) === null || _d === void 0 ? void 0 : _d.country_locale_data[info.country()]) === null || _e === void 0 ? void 0 : _e.postcode;
    var fieldCityInfo = (_h = (_g = (_f = GLOBAL.phpData) === null || _f === void 0 ? void 0 : _f.wc_location_info) === null || _g === void 0 ? void 0 : _g.country_locale_data[info.country()]) === null || _h === void 0 ? void 0 : _h.city;
    var fieldStateInfo = (_l = (_k = (_j = GLOBAL.phpData) === null || _j === void 0 ? void 0 : _j.wc_location_info) === null || _k === void 0 ? void 0 : _k.country_locale_data[info.country()]) === null || _l === void 0 ? void 0 : _l.state;
    var shippingPostalCode = PeachPayCustomer.shipping.postal();
    var shippingCity = PeachPayCustomer.shipping.city();
    var shippingState = PeachPayCustomer.shipping.state();
    var shippingCountry = PeachPayCustomer.shipping.country();
    if (shippingPostalCode === '' && isEnabledField(defaultShortAddress[0], fields !== null && fields !== void 0 ? fields : [], fieldPostalCodeInfo) && isRequiredField(defaultShortAddress[0], fields !== null && fields !== void 0 ? fields : [], fieldPostalCodeInfo)) {
        return true;
    }
    if (shippingCity === '' && isEnabledField(defaultShortAddress[1], fields !== null && fields !== void 0 ? fields : [], fieldCityInfo) && isRequiredField(defaultShortAddress[1], fields !== null && fields !== void 0 ? fields : [], fieldCityInfo)) {
        return true;
    }
    if (shippingState === '' && isEnabledField(defaultShortAddress[2], fields !== null && fields !== void 0 ? fields : [], fieldStateInfo) && isRequiredField(defaultShortAddress[2], fields !== null && fields !== void 0 ? fields : [], fieldStateInfo)) {
        return true;
    }
    if (shippingCountry === '' && isEnabledField(defaultShortAddress[3], fields !== null && fields !== void 0 ? fields : []) && isRequiredField(defaultShortAddress[3], fields !== null && fields !== void 0 ? fields : [])) {
        return true;
    }
    return false;
}
function collectCustomerFieldData(formIdentifier, requestedFields) {
    ...
    if ($form) {
        ...
        if (requestedFields) {
            ...
            Object.keys(formFields_1).forEach(function (fieldName) {
                if (!requestedFields.includes(fieldName)) {
                    delete formFields_1[fieldName];
                }
            });
        }
        else {
...
function initCustomerEvents(message) {
    var _this = this;
    var _a, _b, _c, _d;
    $qsAll('.save-payment-info-checkbox', function ($el) {
        $el === null || $el === void 0 ? void 0 : $el.addEventListener('change', function () {
    ...
    (_d = $qs('#pp-different-shipping-details')) === null || _d === void 0 ? void 0 : _d.addEventListener('change', function (event) {
        ...
        setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!PeachPayCustomer.shipToDifferentAddress()) return [3, 4];
                        syncCustomerFieldChanges('#pp-different-shipping-details');
                        store.dispatch(startModalLoading());
                        isValidAddress = false;
                        if (!((!Carts.virtual() || !Feature.enabled(FeatureFlag.VIRTUAL_PRODUCT_FIELDS)) && !isShortAddressEmpty('shipping'))) return [3, 2];
                    ...
                    case 3:
                        ...
                        if (isValidAddress) {
                            ...
                            $qsAll('.pp-back-to-info', function ($element) { return $element.classList.remove('pp-visibility-0'); });
                        }
                        else {
                            $qs('#pp-continue-to-payment', function ($element) { return $element.disabled = true; });
                            $qsAll('.pp-back-to-info', function ($element) { return $element.classList.add('pp-visibility-0'); });
                        }
                        return [3, 5];
                    case 4:
                        $qs('#pp-continue-to-payment', function ($element) { return $element.disabled = false; });
...
function wcCountryLocaleRuleRender(page) {
    ...
    var country = countryElement === null || countryElement === void 0 ? void 0 : countryElement.value;
    if (!country) {
        return;
    }
...
function wcStatefieldRule(stateFieldInfo, section, formIdentifier) {
    ...
    var fieldData = section === 'billing' ? (_b = (_a = GLOBAL.phpData) === null || _a === void 0 ? void 0 : _a.billing_fields) !== null && _b !== void 0 ? _b : [] : (_d = (_c = GLOBAL.phpData) === null || _c === void 0 ? void 0 : _c.shipping_fields) !== null && _d !== void 0 ? _d : [];
    var fieldIsRequired = isRequiredField("".concat(section, "_state"), fieldData, stateFieldInfo);
    var label = $qs("".concat(formIdentifier, " .").concat(stateField, " label:not(.hide)"));
    if (label) {
        if (fieldIsRequired && (label === null || label === void 0 ? void 0 : label.textContent.match(/\(.*\)/))) {
            (_e = label.textContent) === null || _e === void 0 ? void 0 : _e.replace(/[ ]*\(.*\)[ ]*/, '');
        }
        else if (!fieldIsRequired && !(label === null || label === void 0 ? void 0 : label.textContent.match(/\(.*\)/))) {
            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (inprogressCustomer !== null) {
                        inprogressCustomer.payment_methods = undefined;
                    ...
                    return [2];
                case 3:
                    customer.payment_methods = undefined;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4, fetchWindowData(iFrameWindow, 'pp-clear-existing-customer-data')];
                case 1: return [2, _b.sent()];
            }
        });
    });
}
function updateCustomerDataInBrowser() {
    return __awaiter(this, void 0, void 0, function () {
        var customer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!Environment.customer.saveToBrowserSelected()) return [3, 2];
                    customer = PeachPayCustomer.data();
                    return [4, setCustomer(customer)];
                case 1:
                    _a.sent();
                    return [3, 4];
                case 2: return [4, clearCustomer()];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4: return [2];
...
function renderCorrectProvinceField(phpData, modalPage) {
    ...
    if (merchantShipping) {
        ...
        var _d = stateProvinceOrCounty(country), defaultOption_1 = _d[0], label_1 = _d[1];
        ...
        if (stateOrProvinceOptions_1 && Object.keys(stateOrProvinceOptions_1).length > 0) {
            ...
            (_b = $qs("".concat(name_1, " .").concat(section_1, "_state-field label:not(.pp-select-label)"))) === null || _b === void 0 ? void 0 : _b.classList.add('hide');
        }
        else {
            $qs("".concat(name_1, " .").concat(section_1, "_state-field select"), function ($stateOrProvincesSelect) {
                var _a;
            ...
            (_c = $qs("".concat(name_1, " .").concat(section_1, "_state-field label.pp-select-label"))) === null || _c === void 0 ? void 0 : _c.classList.add('hide');
            $qs("".concat(name_1, " .").concat(section_1, "_state-field input"), function ($stateOrProvincesText) {
                var _a, _b;
...
function renderCustomerHeader(customer) {
    ...
    (_a = $qs('#shipping-options-container-address')) === null || _a === void 0 ? void 0 : _a.classList.remove('hide');
    var shortAddress = getShortAddress();
    var fullAddress = getFullAddress(section);
    var fullName = getFullName(section);
    var formattedFullName = fullName ? fullName + ', ' : '';
    $qsAll("#existing-email", function ($element) { return $element.innerHTML = customer.form_fields["".concat(section, "_email")]; });
    if (formattedFullName === '' && shortAddress.replace(/\s/g, '') === '') {
    ...
    $qsAll("".concat(Environment.customer.existing() ? '#existing-' : '.', "full-name"), function ($element) { return $element.innerHTML = formattedFullName; });
    ...
    $qsAll("".concat(Environment.customer.existing() ? '#existing-' : '.', "pp-address"), function ($element) { return $element.innerHTML = shortAddress; });
    $qsAll("".concat(Environment.customer.existing() ? '#existing-' : '.', "pp-address-hidden"), function ($element) { return $element.innerHTML = fullAddress; });
    $qsAll("".concat(Environment.customer.existing() ? '#existing-' : '.', "pp-return-address-line"), function ($element) { return $element.innerHTML = fullAddress; });
}
...
function getFullName(section) {
    var customerInfoType = section === 'billing' ? PeachPayCustomer.billing : PeachPayCustomer.shipping;
    var fullName = '';
...
function checkRequiredFields() {
    ...
    if (shouldCheckInfoForm) {
        var modalPage = Environment.modalUI.page();
        var primaryFormToCheck = modalPage === 'returning' ? '#pp-info-form-returning' : '#pp-info-form';
        var primaryFormValidity = (_b = (_a = $qs("".concat(primaryFormToCheck))) === null || _a === void 0 ? void 0 : _a.checkValidity()) !== null && _b !== void 0 ? _b : false;
        if (!primaryFormValidity) {
            ...
            if (modalPage === 'shipping') {
                if (PeachPayCustomer.shipToDifferentAddress()) {
                    var result = (_c = $qs("#pp-different-shipping-details")) === null || _c === void 0 ? void 0 : _c.reportValidity();
            ...
            (_d = $qs("".concat(primaryFormToCheck))) === null || _d === void 0 ? void 0 : _d.reportValidity();
            return false;
        }
    }
    ...
    var additionalFieldsValidity = (_e = $qs("#additional-fields-".concat(location1))) === null || _e === void 0 ? void 0 : _e.checkValidity();
    ...
    var accountInfoValidity = (_g = (_f = $qs("#pp-".concat(locationAltNames[location1], "-customer-store-account-info-form"))) === null || _f === void 0 ? void 0 : _f.checkValidity()) !== null && _g !== void 0 ? _g : true;
    if (accountInfoValidity) {
        return true;
    }
    else {
        (_h = $qs("#pp-".concat(locationAltNames[location1], "-customer-store-account-info-form"))) === null || _h === void 0 ? void 0 : _h.reportValidity();
        return false;
    }
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    event.preventDefault();
                    store.dispatch(updateCustomerAddressValidation(false));
                    if (!shipToDifferentAddress) return [3, 2];
                    formFields = PeachPayCustomer.data().form_fields;
...
function initModal(message) {
    ...
    store.subscribe(function () {
        ...
        renderOneClickCheckbox(Environment.modalUI.page());
...
function displayErrorMessage(errorMessage) {
    ...
    if (errorMessage !== '') {
        ...
        (_b = $qs('#pp-pms-existing-container')) === null || _b === void 0 ? void 0 : _b.classList.add('hide');
        ...
        (_f = $qs('#pp-pms-existing-container')) === null || _f === void 0 ? void 0 : _f.classList.remove('hide');
...
function centerModal() {
    ...
    if (modal && ppContainer && modal.clientHeight >= window.innerHeight) {
        ppContainer.classList.add('pp-container-no-center');
    }
    else if (ppContainer) {
        ppContainer.classList.remove('pp-container-no-center');
    }
...
function formGenerator(fieldData, fieldOrder, section, formIdDifferentiator) {
    ...
    if (section === '') {
        ...
        var formFormDiv = document.createElement('div');
    ...
    while (fieldData[fieldOrder[i]]) {
        ...
        if (fieldData[fieldOrder[i]].type_list === 'header') {
            ...
            form.innerHTML += "<div id=\"".concat(fieldData[fieldOrder[i]].field_name, "-field\" class=\"").concat(fieldData[fieldOrder[i]].field_name, "\"><span class=\"pp-info-form-header\">").concat(label, "</span></div>");
            i++;
            continue;
        }
        if (rowSpace < fieldWidth) {
            if (rowSpace !== 0) {
                ...
                element1.classList.add('pp-fw-' + rowSpace);
        ...
        if (rowSpace >= fieldWidth) {
            ...
            rowElement.appendChild(generateFieldElement1(fieldData[fieldOrder[i]], section));
            rowSpace -= fieldWidth;
            i++;
        }
    }
    if (rowElement.innerHTML.length !== 0) {
        if (rowSpace !== 0) {
            ...
            element2.classList.add('pp-fw-' + rowSpace);
...
function generateFieldElement1(fieldData, section) {
    ...
    var inputBuilder = function () { return "<input type=\"".concat(fieldData.type_list, "\"\n\t\t\tname=\"").concat(fieldData.field_name, "\"\n\t\t\tplaceholder=\" \"") + (fieldData.field_default ? "value=\"".concat(fieldData.field_default.replaceAll('"', '&quot;'), "\"") : '') + "class=\"pp-fw-100 text-input\"" + (fieldData.field_required === 'yes' ? ' required' : '') + '/>'; };
    var selectBuilder = function (optionOrder) { return "<select name=".concat(fieldData.field_name, "\n\t\t\tclass=\"pp-fw-100\"\n\t\t\t").concat(fieldData.field_required === 'yes' ? 'required' : '', ">\n\t\t\t\t").concat(optionBuilder(optionOrder), "\n\t\t</select>\n\t\t").concat(labelBuilder()); };
    var optionBuilder = function (optionOrder) {
        if (optionOrder.length === 0) {
            return;
        }
    ...
    var radioFieldBuilder = function (optionOrder) {
        ...
        optionOrder.forEach(function (value) {
            if (value[0] && value[1]) {
                radioFields += "<label class=\"pp-radio-line\"><input type=".concat(fieldData.type_list, "\n\t\t\t\tname=\"").concat(fieldData.field_name, "\"") + "value=\"".concat(value[0], "\"") + "class=\"pp-radio-input\"" + (fieldData.field_required === 'yes' && first ? ' required' : '') + (fieldData.field_default === value[0] ? ' checked' : '') + '/>';
    ...
    if (fieldData.type_list === 'text' || fieldData.type_list === 'email' || fieldData.type_list === 'tel') {
        ...
        element.innerHTML = selectBuilder((_a = fieldData.option_order) !== null && _a !== void 0 ? _a : []);
    }
    else if (fieldData.type_list === 'radio') {
        element.innerHTML = radioFieldBuilder((_b = fieldData.option_order) !== null && _b !== void 0 ? _b : []);
    }
    else if (fieldData.type_list === 'checkbox') {
...
function getLimitedLabel(fieldData, label) {
    ...
    if (fieldWidth === 100 && fieldData.type_list === 'radio') {
        ...
        try {
            var isOptional = fieldData.field_required !== 'yes' && ![
                'Apartment',
                'Apt.'
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, fetchHostWindowData('pp-update-email', {
                            email: email
                        })];
                case 1:
                    _a.sent();
...
function renderOneClickCheckbox(page) {
    if (page === 'payment' || page === 'returning') {
        $qsAll('.pp-save-payment-info-section', function ($el) { return $el.classList.remove('hide'); });
    }
    else {
        $qsAll('.pp-save-payment-info-section', function ($el) { return $el.classList.add('hide'); });
    }
}
...
function consumeCartCalculationResponse(response) {
    ...
    if (response.data) {
        ...
        if (DefaultCart.contents().length === 0) {
            ...
            store.dispatch(setOrderError("<span>".concat(getLocaleText('There are no shipping methods available'), "</span>")));
        }
        else if (PaymentConfiguration.eligibleMethodCount() === 0) {
            store.dispatch(setOrderError("<span>".concat(getLocaleText('There are no payment methods available'), "</span>")));
        }
    }
}
...
function generateMerchantCustomerAccountForm(idDifferentiator) {
    ...
    if (shouldShowMerchantCustomerAccountLoginTypeCheckboxes()) {
        ...
        var label = merchantName + ' ' + getLocaleText('Account');
        ...
        header = "<div class=\"pp-tooltip\">\n\t\t\t\t\t<span class=\"pp-title pp-account-title\">".concat(label, "</span>\n\t\t\t\t\t<span class=\"pp-question-mark\"><img class=\"pp-pm-help-badge\" src=\"img/property-help.svg\"><div class=\"pp-tooltipHidden-point\"></div></span>\n\t\t\t\t\t<span class=\"pp-tooltipHidden\">").concat(accountLoginExplanation, "</span>\n\t\t\t\t</div>");
    }
    else {
        customerAccountFormHeader.field_name = idDifferentiator + '-store-account-form-header';
        var label1 = getCustomerAccountFormHeaderLabel(idDifferentiator);
        fieldData.push(customerAccountFormHeader);
        header = "<div id=\"".concat(customerAccountFormHeader.field_name, "-field\" class=\"").concat(customerAccountFormHeader.field_name, " pp-tooltip\">\n\t\t\t\t\t<span class=\"pp-title pp-account-title\">").concat(label1, "</span>\n\t\t\t\t\t<span class=\"pp-question-mark\"><img class=\"pp-pm-help-badge\" src=\"img/property-help.svg\"><div class=\"pp-tooltipHidden-point\"></div></span>\n\t\t\t\t\t<span class=\"pp-tooltipHidden\">").concat(accountLoginExplanation, "</span>\n\t\t\t\t</div>");
    }
    ...
    return header + formGenerator1(fieldData, fieldOrder, idDifferentiator + '-store-account') + '</div></form>';
}
function formGenerator1(fieldData, fieldOrder, formIdDifferentiator) {
    if (formIdDifferentiator === void 0) { formIdDifferentiator = ''; }
    var formId = "pp-".concat(formIdDifferentiator + (formIdDifferentiator ? '-' : ''), "info-form");
    var form = "<form id=\"".concat(formId, "\" class=\"pp-info-form flex col\"><div class=\"flex col pp-form-rows-container\">");
    var i = 0;
    var rowSpace = 100;
    var rowElement = '';
    while (fieldData[fieldOrder[i]]) {
        ...
        if (rowSpace >= fieldWidth) {
            ...
            rowElement += generateFieldElement2(fieldData[fieldOrder[i]]);
            rowSpace -= fieldWidth;
            i++;
        }
    }
...
function generateFieldElement2(fieldData) {
    var _a;
    var fieldWidth = parseInt(fieldData.width);
    ...
    var label = fieldData.field_label;
    var labelBuilder = function () { return "<label\n\t\t\ttitle=\"".concat(label, "\"\n\t\t\tfor=\"").concat(fieldData.field_name, "\"\n\t\t\tclass=\"pp-form-label\"\n\t\t>\n\t\t\t").concat(label, "\n\t\t</label>\n\t\t"); };
    ...
    if (fieldData.type_list === 'text' || fieldData.type_list === 'email' || fieldData.type_list === 'tel') {
        ...
        elementString += radioFieldBuilder((_a = fieldData.option_order) !== null && _a !== void 0 ? _a : []);
        elementString += '</div>';
        return elementString;
    }
    else if (fieldData.type_list === 'password') {
...
function initSentry(message) {
    try {
        if (window['Sentry']) {
            ...
            var isDev = isDevEnvironment(apiUrl);
            Sentry.init({
...
function bundleQuantityLabel(item) {
    var bundleItemQuantity = '';
    if (item.is_part_of_bundle) {
        var bundle = DefaultCart.contents().find(function (cartItem) { return cartItem.item_key === item.bundled_by; });
        if (bundle && !isNaN(parseInt(bundle.quantity))) {
            bundleItemQuantity = " \u00D7 ".concat(cartItemQuantity(item) / parseInt(bundle.quantity));
        }
    }
...
function cartItemDisplayAmount(item) {
    ...
    if (item.is_bundle) {
        var bundlePrice_1 = Number.parseFloat((_e = item.display_price) !== null && _e !== void 0 ? _e : item.price);
        var bundleTotal_1 = bundlePrice_1 * Number.parseFloat(item.quantity);
        var subItems = DefaultCart.contents().filter(function (cartItem) { return cartItem.bundled_by === item.item_key; });
        subItems.forEach(function (subItem) {
            var _a;
            if (bundlePrice_1 > 0) {
                var subItemPrice = Number.parseFloat((_a = subItem.display_price) !== null && _a !== void 0 ? _a : subItem.price);
                bundleTotal_1 += subItemPrice * Number.parseFloat(subItem.quantity);
            }
        });
        return "".concat(formatCurrencyString(bundleTotal_1));
    }
    if (item.is_part_of_bundle) {
        return "".concat(formatCurrencyString(Number.parseFloat((_f = item.display_price) !== null && _f !== void 0 ? _f : item.price)), "/").concat(getLocaleText('each'));
    }
    return "".concat(formatCurrencyString(Number.parseFloat((_g = item.display_price) !== null && _g !== void 0 ? _g : item.price) * cartItemQuantity(item)));
}
...
function renderBundleItem(item) {
    ...
    $labelDiv.innerHTML = "".concat(cartItemLabel(item)).concat(bundleQuantityLabel(item));
    var $bundleItemTopRow = document.createElement('div');
...
function createSetupIntent(sessionId, paymentMethodType, paymentMethodId) {
    return __awaiter(this, void 0, void 0, function () {
        var url, security, formData, response, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = Feature.metadata(FeatureFlag.STRIPE_GATEWAYS, 'setup_intent_url');
                    security = Feature.metadata(FeatureFlag.STRIPE_GATEWAYS, 'setup_intent_nonce');
                    if (!url || !security) {
                        return [2, null];
                    }
                ...
                case 2:
                    ...
                    return [2, data.data.setup_intent_details.client_secret];
            }
        });
    });
}
function initStripeACHDebitMethod() {
    ...
    return {
        config: {
            ...
            gateway: 'peachpay_stripe_achdebit',
            reusable: false,
            assets: {
                title: {
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_ACHDEBIT_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_ACHDEBIT_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_ACHDEBIT_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'USD'
                ],
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_ACHDEBIT_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'US'
                ],
                productTypes: [
                    'subscriptions'
        ...
        tokenize: function (context, sessionId) {
            var _a, _b;
            return __awaiter(this, void 0, void 0, function () {
                var stripe, clientSecret, _c, collectError, collectIntent, mandateResponse, message, _d, confirmError, confirmIntent;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            stripe = context.stripe;
                            return [4, createSetupIntent(sessionId, 'us_bank_account')];
                        case 1:
                            ...
                            return [4, stripe.collectBankAccountForSetup({
                        ...
                        case 2:
                            _c = _e.sent(), collectError = _c.error, collectIntent = _c.setupIntent;
                            if (collectError || !collectIntent) {
                                return [2, [
                                        null,
                                        {
                                            paymentStatus: 'creationfailed',
                                            note: (_a = collectError === null || collectError === void 0 ? void 0 : collectError.message) !== null && _a !== void 0 ? _a : 'Failed to collect bank account for setup intent.'
                                        }
                                    ]];
                            }
                            ...
                            return [4, displayMandate({
                                    fullName: PeachPayCustomer.billing.fullName(),
                                    clientName: MerchantConfiguration.name()
                                })];
                        case 3:
                            mandateResponse = _e.sent();
                            if (!mandateResponse) {
                                message = getLocaleText('The required mandate was not accepted. Payment canceled.');
                                return [2, [
                                        null,
                                        {
                                            note: message
                            ...
                            return [4, stripe.confirmUsBankAccountSetup(clientSecret)];
                        case 4:
                            _d = _e.sent(), confirmError = _d.error, confirmIntent = _d.setupIntent;
                            if (confirmError || !confirmIntent) {
                                return [2, [
                                        null,
                                        {
                                            paymentStatus: 'creationfailed',
                                            note: (_b = confirmError === null || confirmError === void 0 ? void 0 : confirmError.message) !== null && _b !== void 0 ? _b : 'Failed to confirm setup intent.'
                                        }
                                    ]];
                            }
                            if (confirmIntent.status !== 'succeeded') {
                                return [2, [
                                        ...
                                        {
                                            paymentStatus: 'creationfailed',
                                            note: "Setup intent resulted in invalid status(".concat(confirmIntent.status, ")")
                                        }
                                    ]];
                            }
                            return [2, [
        ...
        confirm: function (context, clientSecret) {
            var _a;
            return __awaiter(this, void 0, void 0, function () {
                var stripe, _b, paymentIntent, error, message;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            stripe = context.stripe;
                            return [4, stripe.retrievePaymentIntent(clientSecret)];
                        case 1:
                            _b = _c.sent(), paymentIntent = _b.paymentIntent, error = _b.error;
                            if (error || !paymentIntent) {
                                message = (_a = error === null || error === void 0 ? void 0 : error.message) !== null && _a !== void 0 ? _a : 'Failed to retrieve payment intent.';
                                return [2, [
                                        null,
                                        {
                                            note: message
                            ...
                            return [2, [
                                    null,
                                    {
                                        note: "Failed to confirm payment intent with status(".concat(paymentIntent.status, ")")
                                    }
                                ]];
                    }
                });
...
function initStripeAffirmMethod() {
    ...
    return {
        config: {
            name: 'Affirm',
            slug: 'affirm',
            gateway: 'peachpay_stripe_affirm',
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_AFFIRM_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_AFFIRM_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_AFFIRM_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'USD'
                ],
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_AFFIRM_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'US'
                ],
                productTypes: [],
                virtualProducts: true,
        ...
        tokenize: function (context) { return __awaiter(_this, void 0, void 0, function () {
            var stripe, _a, paymentMethod, error, message;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        stripe = context.stripe;
                        return [4, stripe.createPaymentMethod({
                                type: 'affirm',
                                billing_details: PeachPayCustomer.stripeBillingDetails()
                            })];
                    case 1:
                        _a = _c.sent(), paymentMethod = _a.paymentMethod, error = _a.error;
                        if (error) {
                            message = (_b = error.message) !== null && _b !== void 0 ? _b : 'Failed to tokenize payment method.';
                            return [2, [
                                    null,
                                    {
                                        paymentStatus: 'creationfailed',
        ...
        confirm: function (context, clientSecret, intermediateURL) { return __awaiter(_this, void 0, void 0, function () {
            var stripe, _a, paymentIntent, error, message;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 1:
                        _a = _c.sent(), paymentIntent = _a.paymentIntent, error = _a.error;
                        if (error) {
                            message = (_b = error.message) !== null && _b !== void 0 ? _b : 'Failed to confirm payment.';
                            return [2, [
                                    null,
                                    {
                                        note: message
...
function initStripeAfterPayMethod() {
    ...
    return {
        config: {
            name: 'Afterpay',
            slug: 'afterpay',
            gateway: 'peachpay_stripe_afterpay',
            description: getLocaleText('After selecting pay you will be redirected to complete your payment.'),
            reusable: false,
            assets: {
                title: {
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_AFTERPAY_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_AFTERPAY_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_AFTERPAY_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'USD',
                    'CAD',
                    'GBP',
                    'AUD',
                ...
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_AFTERPAY_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'US',
                    'CA',
                    'GB',
                    'AU',
...
var SUPPORTED_ZERO_DECIMAL_CURRENCIES = [
    'BIF',
    'CLP',
    'DJF',
    'GNF',
...
function createPaymentRequestOptions() {
    var _a;
    var cart = store.getState().calculatedCarts[0].cart;
    var summary = store.getState().calculatedCarts[0].summary;
    var needsShipping = !store.getState().calculatedCarts[0].cart_meta.is_virtual;
    var shippingPackage = store.getState().calculatedCarts[0].package_record[0];
    var data = {
        country: (_a = Feature.metadata(FeatureFlag.STRIPE_GATEWAYS, 'country')) !== null && _a !== void 0 ? _a : 'US',
        ...
        displayItems: cart.map(function (l) { return ({
            label: l.name,
            amount: formatCurrency(Number.parseFloat(l.total) * Number.parseInt(l.quantity), MerchantConfiguration.currency.code())
        }); }),
    ...
    if (needsShipping) {
        ...
        var packageMethod = shippingPackage.methods[shippingPackage.selected_method];
        if (!packageMethod) {
            return data;
        }
        ...
        data.shippingOptions = [
            {
                id: shippingPackage.selected_method,
                label: packageMethod.title,
                amount: formatCurrency(packageMethod.total, MerchantConfiguration.currency.code()),
                detail: packageMethod.description
            }
        ];
    }
    return data;
}
function updatePaymentRequestOptions() {
    var cart = store.getState().calculatedCarts[0].cart;
    var summary = store.getState().calculatedCarts[0].summary;
    var needsShipping = !store.getState().calculatedCarts[0].cart_meta.is_virtual;
    var shippingPackage = store.getState().calculatedCarts[0].package_record[0];
...
function eventPaymentRequestOptions(status) {
    var cart = store.getState().calculatedCarts[0].cart;
    var summary = store.getState().calculatedCarts[0].summary;
    var needsShipping = !store.getState().calculatedCarts[0].cart_meta.is_virtual;
    var shippingPackage = store.getState().calculatedCarts[0].package_record[0];
...
function handleAddressChangeEvent(event) {
    var _a, _b, _c, _d, _e, _f;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    store.dispatch(updateCustomerFields(__assign(__assign({}, PeachPayCustomer.data().form_fields), { shipping_address_1: (_a = event.shippingAddress.addressLine[0]) !== null && _a !== void 0 ? _a : '', shipping_address_2: (_b = event.shippingAddress.addressLine[1]) !== null && _b !== void 0 ? _b : '', shipping_city: (_c = event.shippingAddress.city) !== null && _c !== void 0 ? _c : '', shipping_postcode: (_d = event.shippingAddress.postalCode) !== null && _d !== void 0 ? _d : '', shipping_state: (_e = event.shippingAddress.region) !== null && _e !== void 0 ? _e : '', shipping_country: (_f = event.shippingAddress.country) !== null && _f !== void 0 ? _f : '' })));
                    return [4, requestCartCalculation()];
                case 1:
                    _g.sent();
                    event.updateWith(eventPaymentRequestOptions('success'));
                    return [2];
            }
        });
    });
}
function tokenizePaymentRequest(paymentRequest) {
    return new Promise(function (resolve) {
        paymentRequest === null || paymentRequest === void 0 ? void 0 : paymentRequest.on('paymentmethod', function (event) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11;
            paymentRequest = null;
            var customerFields = {
                'billing_email': (_a = event.payerEmail) !== null && _a !== void 0 ? _a : PeachPayCustomer.billing.email(),
                'billing_first_name': (_c = (_b = event.payerName.split(' ')) === null || _b === void 0 ? void 0 : _b[0]) !== null && _c !== void 0 ? _c : PeachPayCustomer.billing.firstName(),
                'billing_last_name': (_e = (_d = event.payerName.split(' ')) === null || _d === void 0 ? void 0 : _d[1]) !== null && _e !== void 0 ? _e : PeachPayCustomer.billing.lastName(),
                'billing_phone': (_f = event.payerPhone) !== null && _f !== void 0 ? _f : PeachPayCustomer.billing.phone(),
                'billing_address_1': (_h = (_g = event.paymentMethod.billing_details.address) === null || _g === void 0 ? void 0 : _g.line1) !== null && _h !== void 0 ? _h : PeachPayCustomer.billing.address1(),
                'billing_address_2': (_k = (_j = event.paymentMethod.billing_details.address) === null || _j === void 0 ? void 0 : _j.line2) !== null && _k !== void 0 ? _k : PeachPayCustomer.billing.address2(),
                'billing_city': (_m = (_l = event.paymentMethod.billing_details.address) === null || _l === void 0 ? void 0 : _l.city) !== null && _m !== void 0 ? _m : PeachPayCustomer.billing.city(),
                'billing_state': (_p = (_o = event.paymentMethod.billing_details.address) === null || _o === void 0 ? void 0 : _o.state) !== null && _p !== void 0 ? _p : PeachPayCustomer.billing.state(),
                'billing_country': (_r = (_q = event.paymentMethod.billing_details.address) === null || _q === void 0 ? void 0 : _q.country) !== null && _r !== void 0 ? _r : PeachPayCustomer.billing.country(),
                'billing_postcode': (_t = (_s = event.paymentMethod.billing_details.address) === null || _s === void 0 ? void 0 : _s.postal_code) !== null && _t !== void 0 ? _t : PeachPayCustomer.billing.postal(),
                'billing_company': '',
                'shipping_email': PeachPayCustomer.shipping.email(),
                'shipping_first_name': PeachPayCustomer.shipping.firstName(),
                'shipping_last_name': PeachPayCustomer.shipping.lastName(),
                'shipping_phone': (_v = (_u = event.shippingAddress) === null || _u === void 0 ? void 0 : _u.phone) !== null && _v !== void 0 ? _v : PeachPayCustomer.shipping.phone(),
                'shipping_company': (_x = (_w = event.shippingAddress) === null || _w === void 0 ? void 0 : _w.recipient) !== null && _x !== void 0 ? _x : PeachPayCustomer.shipping.company(),
                'shipping_address_1': (_0 = (_z = (_y = event.shippingAddress) === null || _y === void 0 ? void 0 : _y.addressLine) === null || _z === void 0 ? void 0 : _z[0]) !== null && _0 !== void 0 ? _0 : PeachPayCustomer.shipping.address1(),
                'shipping_address_2': (_3 = (_2 = (_1 = event.shippingAddress) === null || _1 === void 0 ? void 0 : _1.addressLine) === null || _2 === void 0 ? void 0 : _2[1]) !== null && _3 !== void 0 ? _3 : PeachPayCustomer.shipping.address2(),
                'shipping_city': (_5 = (_4 = event.shippingAddress) === null || _4 === void 0 ? void 0 : _4.city) !== null && _5 !== void 0 ? _5 : PeachPayCustomer.shipping.city(),
                'shipping_state': (_7 = (_6 = event.shippingAddress) === null || _6 === void 0 ? void 0 : _6.region) !== null && _7 !== void 0 ? _7 : PeachPayCustomer.shipping.state(),
                'shipping_country': (_9 = (_8 = event.shippingAddress) === null || _8 === void 0 ? void 0 : _8.country) !== null && _9 !== void 0 ? _9 : PeachPayCustomer.shipping.country(),
                'shipping_postcode': (_11 = (_10 = event.shippingAddress) === null || _10 === void 0 ? void 0 : _10.postalCode) !== null && _11 !== void 0 ? _11 : PeachPayCustomer.shipping.postal(),
                'ship_to_different_address': 'true'
            };
            store.dispatch(updateCustomerFields(customerFields));
        ...
        paymentRequest === null || paymentRequest === void 0 ? void 0 : paymentRequest.on('cancel', function () {
            paymentRequest = null;
            resolve([
                null,
                {
        ...
        paymentRequest === null || paymentRequest === void 0 ? void 0 : paymentRequest.on('shippingaddresschange', handleAddressChangeEvent);
        paymentRequest === null || paymentRequest === void 0 ? void 0 : paymentRequest.show();
    });
}
function formatCurrency(amount, currencyCode) {
    var total = Number.parseFloat(amount + '');
    if (!SUPPORTED_ZERO_DECIMAL_CURRENCIES.includes(currencyCode)) {
        total = total * 100;
    }
    return Math.round(total);
}
function initStripeApplepayMethod() {
    var _this = this;
    var _a, _b, _c, _d;
    ...
    var config = {
        ...
        slug: 'card',
        gateway: 'peachpay_stripe_applepay',
        ...
        supports: {
            minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_APPLEPAY_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
            maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_APPLEPAY_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
            currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_APPLEPAY_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                'ALL'
            ],
            customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_APPLEPAY_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                'ALL'
            ],
            productTypes: [
                'subscriptions'
    ...
    store.subscribe(function () {
        paymentRequest === null || paymentRequest === void 0 ? void 0 : paymentRequest.update(updatePaymentRequestOptions());
    });
    var init = function (stripe) { return __awaiter(_this, void 0, void 0, function () {
        var result, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    result = _a.sent();
                    if (!(result === null || result === void 0 ? void 0 : result.googlePay)) {
    ...
    return {
        ...
        tokenize: function (context, sessionId) {
            var _a;
            return __awaiter(this, void 0, void 0, function () {
                var stripe, localPaymentRequest, _b, paymentMethodId, update, clientSecret, _c, confirmError, confirmIntent;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            stripe = context.stripe;
                            ...
                            localPaymentRequest = paymentRequest;
                            paymentRequest = null;
                            return [4, tokenizePaymentRequest(localPaymentRequest)];
                        case 1:
                            _b = _d.sent(), paymentMethodId = _b[0], update = _b[1];
                            if (!!paymentMethodId) return [3, 3];
                            return [4, init(stripe)];
                        case 2:
                            _d.sent();
                            return [2, [
                                    null,
                        ...
                        case 3: return [4, createSetupIntent(sessionId, 'card', paymentMethodId)];
                        case 4:
                            clientSecret = _d.sent();
                            if (!!clientSecret) return [3, 6];
                            return [4, init(stripe)];
                        case 5:
                            _d.sent();
                            return [2, [
                        ...
                        case 6: return [4, stripe.confirmCardSetup(clientSecret)];
                        case 7:
                            _c = _d.sent(), confirmError = _c.error, confirmIntent = _c.setupIntent;
                            if (!(confirmError || !confirmIntent)) return [3, 9];
                            return [4, init(stripe)];
                        case 8:
                            _d.sent();
                            return [2, [
                                    ...
                                    {
                                        paymentStatus: 'creationfailed',
                                        note: (_a = confirmError === null || confirmError === void 0 ? void 0 : confirmError.message) !== null && _a !== void 0 ? _a : 'Failed to confirm setup intent.'
                                    }
                                ]];
                        case 9:
                            if (!(confirmIntent.status !== 'succeeded')) return [3, 11];
                            return [4, init(stripe)];
                        case 10:
                            _d.sent();
                            return [2, [
...
function initStripeBancontactMethod() {
    ...
    return {
        config: {
            name: 'Bancontact',
            slug: 'bancontact',
            gateway: 'peachpay_stripe_bancontact',
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_BANCONTACT_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_BANCONTACT_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_BANCONTACT_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'EUR'
                ],
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_BANCONTACT_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'BE'
                ],
                productTypes: [],
                virtualProducts: true,
...
function initStripeCardMethod() {
    ...
    var config = {
        ...
        supports: {
            minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_CARD_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
            maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_CARD_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
            currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_CARD_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                'ALL'
            ],
            customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_CARD_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                'ALL'
            ],
            productTypes: [
                'subscriptions'
    ...
    return {
        ...
        tokenize: function (context) {
            var _a;
            return __awaiter(this, void 0, void 0, function () {
                var stripe, elements, $card, _b, paymentMethod, error, message;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            stripe = context.stripe, elements = context.elements;
                        ...
                        case 1:
                            ...
                            if (error) {
                                message = (_a = error.message) !== null && _a !== void 0 ? _a : 'Failed to tokenize payment method.';
                                return [2, [
                                        null,
                                        {
                                            paymentStatus: 'creationfailed',
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            _b = _c.sent(), paymentIntent = _b.paymentIntent, error = _b.error;
                            if (error) {
                                message = (_a = error.message) !== null && _a !== void 0 ? _a : 'Failed to confirm payment.';
                                return [2, [
                                        null,
                                        {
                                            note: message
        ...
        displayPaymentError: displayCardError
    };
}
...
function initStripeEPSMethod() {
    ...
    return {
        config: {
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_EPS_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_EPS_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_EPS_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'EUR'
                ],
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_EPS_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'AT'
                ],
                productTypes: [],
                virtualProducts: true,
...
function initStripeGiropayMethod() {
    ...
    return {
        config: {
            name: 'giropay',
            slug: 'giropay',
            gateway: 'peachpay_stripe_giropay',
            description: getLocaleText('After selecting <b>Pay</b> you will be redirected to complete your payment.'),
            reusable: false,
            assets: {
                title: {
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_GIROPAY_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_GIROPAY_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_GIROPAY_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'EUR'
                ],
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_GIROPAY_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'DE'
                ],
                productTypes: [],
                virtualProducts: true,
        ...
        confirm: function (context, clientSecret, intermediateURL) { return __awaiter(_this, void 0, void 0, function () {
            var stripe, _a, error, paymentIntent, message;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
...
function initStripeGooglepayMethod() {
    var _this = this;
    var _a, _b, _c, _d;
    var paymentRequest = null;
    var config = {
        ...
        slug: 'card',
        gateway: 'peachpay_stripe_googlepay',
        ...
        supports: {
            minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_GOOGLEPAY_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
            maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_GOOGLEPAY_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
            currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_GOOGLEPAY_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                'ALL'
            ],
            customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_GOOGLEPAY_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                'ALL'
            ],
            productTypes: [
                'subscriptions'
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 5: return [4, createSetupIntent(sessionId, 'card', paymentMethodId)];
                        case 6:
                            clientSecret = _d.sent();
                            if (!!clientSecret) return [3, 8];
                            return [4, init(stripe)];
                        case 7:
                            _d.sent();
                            return [2, [
                        ...
                        case 8: return [4, stripe.confirmCardSetup(clientSecret)];
                        case 9:
                            _c = _d.sent(), confirmError = _c.error, confirmIntent = _c.setupIntent;
                            if (!(confirmError || !confirmIntent)) return [3, 11];
                            return [4, init(stripe)];
                        case 10:
                            _d.sent();
                            return [2, [
                        ...
                        case 11:
                            if (!(confirmIntent.status !== 'succeeded')) return [3, 13];
                            return [4, init(stripe)];
                        case 12:
                            _d.sent();
                            return [2, [
...
function initStripeIdealMethod() {
    ...
    return {
        config: {
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_IDEAL_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_IDEAL_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_IDEAL_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'EUR'
                ],
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_IDEAL_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'NL'
                ],
                productTypes: [],
                virtualProducts: true,
        ...
        tokenize: function (context) { return __awaiter(_this, void 0, void 0, function () {
            var stripe, elements, $idealBank, _a, paymentMethod, error, message;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
...
function initStripeKlarnaMethod() {
    ...
    return {
        config: {
            name: 'Klarna',
            slug: 'klarna',
            gateway: 'peachpay_stripe_klarna',
            description: getLocaleText('After selecting pay you will be redirected to complete your payment.'),
            reusable: false,
            assets: {
                title: {
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_KLARNA_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_KLARNA_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_KLARNA_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'ALL'
                ],
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_KLARNA_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'ALL'
                ],
                productTypes: [],
                virtualProducts: true,
...
function initStripeP24Method() {
    ...
    return {
        config: {
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_P24_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_P24_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_P24_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'EUR',
                    'PLN'
                ],
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_P24_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'PL'
                ],
                productTypes: [],
                virtualProducts: true,
...
function initStripeSofortMethod() {
    ...
    return {
        config: {
            name: 'Sofort',
            slug: 'sofort',
            gateway: 'peachpay_stripe_sofort',
            description: getLocaleText('After selecting <b>Pay</b> you will be redirected to complete your payment.'),
            reusable: false,
            assets: {
                title: {
            ...
            supports: {
                minimumTotal: (_a = Feature.metadata(FeatureFlag.STRIPE_SOFORT_GATEWAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
                maximumTotal: (_b = Feature.metadata(FeatureFlag.STRIPE_SOFORT_GATEWAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
                currencies: (_c = Feature.metadata(FeatureFlag.STRIPE_SOFORT_GATEWAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                    'EUR'
                ],
                customerCountries: (_d = Feature.metadata(FeatureFlag.STRIPE_SOFORT_GATEWAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                    'AT',
                    'BE',
                    'DE',
                    'IT',
        ...
        tokenize: function (context) { return __awaiter(_this, void 0, void 0, function () {
            var stripe, _a, error, paymentMethod, message;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 1:
                        _a = _c.sent(), error = _a.error, paymentMethod = _a.paymentMethod;
                        if (error) {
                            message = (_b = error.message) !== null && _b !== void 0 ? _b : 'Failed to tokenize payment method.';
                            return [2, [
                                    null,
...
function initStripePaymentProvider(orderService) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!Feature.enabled(FeatureFlag.STRIPE_GATEWAYS)) {
                        return [2];
                    }
                    return [4, loadScript('https://js.stripe.com/v3/', 'Stripe', function () {
                            var _a;
                            var publicKey = Feature.metadata(FeatureFlag.STRIPE_GATEWAYS, 'public_key');
                            var connectId = Feature.metadata(FeatureFlag.STRIPE_GATEWAYS, 'connect_id');
                            ...
                            var paymentMethods = setupStripeMethods();
...
function setupStripeMethods() {
    ...
    if (Feature.enabled(FeatureFlag.STRIPE_APPLEPAY_GATEWAY)) {
        var applepayMethod = initStripeApplepayMethod();
        paymentMethods['applepay'] = applepayMethod;
    }
    if (Feature.enabled(FeatureFlag.STRIPE_GOOGLEPAY_GATEWAY)) {
        var googlepayMethod = initStripeGooglepayMethod();
        paymentMethods['googlepay'] = googlepayMethod;
    }
    var stripeProvider = {
        'methods': {}
    };
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    confirm1 = function (event) {
                        ...
                        return paymentFlow(context, method, orderService);
                    };
                    $qsAll('.stripe-btn', function ($el) { return $el.addEventListener('click', function (event) { return confirm1(event); }); });
                    return [2];
            }
        });
    });
}
function paymentFlow(context, payment, orderService) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function () {
        var _e, paymentId, update, transaction, order, dataURL, _f, name, data, paymentData, clientSecret, intermediateURL, successURL, _g, status_1, update1, error_8;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    store.dispatch(startModalProcessing());
                    return [4, payment.tokenize(context, PeachPayOrder.sessionId())];
                case 1:
                    _e = _h.sent(), paymentId = _e[0], update = _e[1];
                    if (!paymentId && update.note) {
                        (_a = payment === null || payment === void 0 ? void 0 : payment.displayPaymentError) === null || _a === void 0 ? void 0 : _a.call(payment, (_b = update.note) !== null && _b !== void 0 ? _b : '');
                    }
                    return [4, orderService.startTransaction(payment.config.gateway)];
                case 2:
                    transaction = _h.sent();
                    if (!transaction) {
                        store.dispatch(stopModalLoading());
                    ...
                    if (!!paymentId) return [3, 4];
                    return [4, transaction.complete(update)];
                case 3:
                    _h.sent();
                    store.dispatch(stopModalLoading());
                    return [2];
                case 4: return [4, orderService.placeOrder(transaction, {
                        peachpay_session_id: PeachPayOrder.sessionId(),
                ...
                case 6:
                    ...
                    return [2];
                case 7:
                    dataURL = new URL(order.redirect);
                    _f = dataURL.hash.split('='), name = _f[0], data = _f[1];
                    if (!(name !== '#payment_data' || !data)) return [3, 9];
                    return [4, transaction.complete()];
                case 8:
                    _h.sent();
                    store.dispatch(stopModalLoading());
                    return [2];
                case 9:
                    paymentData = JSON.parse(atob(decodeURIComponent(data)));
                    clientSecret = paymentData.data.client_secret;
                    intermediateURL = paymentData.intermediate_url;
                    successURL = paymentData.success_url;
                    _h.label = 10;
                case 10:
                    _h.trys.push([10, 13, , 15]);
                    return [4, payment.confirm(context, clientSecret, intermediateURL)];
                case 11:
                    _g = _h.sent(), status_1 = _g[0], update1 = _g[1];
                    if (!status_1 && update1.note) {
                        (_c = payment === null || payment === void 0 ? void 0 : payment.displayPaymentError) === null || _c === void 0 ? void 0 : _c.call(payment, (_d = update1.note) !== null && _d !== void 0 ? _d : '');
                    }
                    return [4, transaction.complete(update1)];
                case 12:
                    _h.sent();
                    if (!status_1) {
                        store.dispatch(stopModalLoading());
...
function renderPayPalButtonDisplay(provider, loadingMode) {
    var _a, _b, _c, _d, _e, _f;
    if (provider === 'paypal' && loadingMode === 'finished' && PaymentConfiguration.methodSupportsCurrentCurrency('paypal', 'default') && DefaultCart.total() > 0) {
        ...
        $qsAll('.pp-paypal-spinner-container').forEach(function (element) {
            element.classList.remove('hide');
        });
    }
    else {
...
function getCurrentlyUsedTransactionThreshold(featureFlag, minOrMax) {
    var _a, _b;
    var temp = Feature.metadata(featureFlag, 'limits');
    if (!temp) {
        return 'n/a';
    }
    var data = temp;
...
function initPayPalDefaultMethod() {
    return {
        config: {
            ...
            supports: {
                minimumTotal: getCurrentlyUsedTransactionThreshold(FeatureFlag.PAYPAL, 'min'),
                maximumTotal: getCurrentlyUsedTransactionThreshold(FeatureFlag.PAYPAL, 'max'),
                currencies: [
                    'AUD',
                    'CAD',
                    'CZK',
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (error_9 instanceof Error) {
                        captureSentryException(error_9);
                    }
                    return [2, false];
...
function handlePayPalApprove(data, actions, orderService) {
    return __awaiter(this, void 0, void 0, function () {
        var orderResponse, error_10, capture, transactionId;
        return __generator(this, function (_a) {
            switch (_a.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, loadScript('https://static-na.payments-amazon.com/checkout.js', 'amazon', function () {
...
function initAmazonPayMethod() {
    ...
    return {
        config: {
            ...
            supports: {
                minimumTotal: getCurrentlyUsedTransactionThreshold(FeatureFlag.AMAZON, 'min'),
                maximumTotal: getCurrentlyUsedTransactionThreshold(FeatureFlag.AMAZON, 'max'),
                currencies: (_a = Feature.metadata(FeatureFlag.AMAZON, 'supported_currencies')) !== null && _a !== void 0 ? _a : [
                    'ALL'
                ],
                customerCountries: (_b = Feature.metadata(FeatureFlag.AMAZON, 'supported_countries')) !== null && _b !== void 0 ? _b : [
                    'ALL'
                ],
                productTypes: [],
                virtualProducts: true,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, loadScript('https://maps.googleapis.com/maps/api/js?key=AIzaSyAL_j0UvKJacQhZ3OedCj_bkcTbuO63MVU&libraries=places', 'google', function () {
...
function fillInAddress(section, modalPage, phpData) {
    ...
    var address1Field = $qs("".concat(formIdentifier, " [name=\"").concat(section, "_address_1\"]:not(.hide)"));
    var address2Field = $qs("".concat(formIdentifier, " [name=\"").concat(section, "_address_2\"]:not(.hide)"));
    var postalField = $qs("".concat(formIdentifier, " [name=\"").concat(section, "_postcode\"]:not(.hide)"));
    var cityField = $qs("".concat(formIdentifier, " [name=\"").concat(section, "_city\"]:not(.hide)"));
    var stateField = $qs("".concat(formIdentifier, " [name=\"").concat(section, "_state\"]:not(.hide)"));
    var provinceField = $qs("".concat(formIdentifier, " [name=\"").concat(section, "_province\"]:not(.hide)"));
    if (address1Field) {
        address1Field.value = '';
    }
    if (address2Field) {
    ...
    var postcode = '';
    for (var _i = 0, _c = place.address_components; _i < _c.length; _i++) {
        var component = _c[_i];
        ...
        switch (componentType) {
            ...
            case 'administrative_area_level_1':
                {
                    var allowedStatesOrProvinces = (_b = (_a = phpData.wc_location_info) === null || _a === void 0 ? void 0 : _a.allowed_states_or_provinces[country.short_name]) !== null && _b !== void 0 ? _b : {};
                    var isInputField = [
                        stateField === null || stateField === void 0 ? void 0 : stateField.tagName,
                        provinceField === null || provinceField === void 0 ? void 0 : provinceField.tagName
                    ].includes('INPUT');
                    ...
                    var stateValue = isInputField ? component.long_name : Object.keys(allowedStatesOrProvinces).includes(component.short_name) ? component.short_name : findStateKeyByValue(component.long_name, allowedStatesOrProvinces);
...
function findStateKeyByValue(value, allowedStatesOrProvinces) {
    return Object.keys(allowedStatesOrProvinces).find(function (key) { return allowedStatesOrProvinces[key] === value; });
}
...
function customButtonMountTargetBase() {
    ...
    else if (Environment.customer.mobile()) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    scriptURL = Environment.isTestOrDevSite() ? SQUARE_SANDBOX_SCRIPT : SQUARE_PRODUCTION_SCRIPT;
                    return [4, loadScript(scriptURL, 'Square', function () {
                            var _a, _b, _c, _d, _e;
...
function handleTokenResult(result) {
    ...
    switch (result.status) {
        case 'OK':
            {
                var billingContact = (_a = result.details) === null || _a === void 0 ? void 0 : _a.billing;
                var shippingContact = (_d = (_c = (_b = result.details) === null || _b === void 0 ? void 0 : _b.shipping) === null || _c === void 0 ? void 0 : _c.contact) !== null && _d !== void 0 ? _d : (_e = result.details) === null || _e === void 0 ? void 0 : _e.billing;
                store.dispatch(updateCustomerFields(__assign(__assign({}, PeachPayCustomer.data()['form_fields']), { ship_to_different_address: '1', billing_email: (_f = billingContact === null || billingContact === void 0 ? void 0 : billingContact.email) !== null && _f !== void 0 ? _f : PeachPayCustomer.billing.email(), billing_first_name: (_g = billingContact === null || billingContact === void 0 ? void 0 : billingContact.givenName) !== null && _g !== void 0 ? _g : PeachPayCustomer.billing.firstName(), billing_last_name: (_h = billingContact === null || billingContact === void 0 ? void 0 : billingContact.familyName) !== null && _h !== void 0 ? _h : PeachPayCustomer.billing.lastName(), billing_phone: (_j = billingContact === null || billingContact === void 0 ? void 0 : billingContact.phone) !== null && _j !== void 0 ? _j : PeachPayCustomer.billing.phone(), billing_address_1: (_l = (_k = billingContact === null || billingContact === void 0 ? void 0 : billingContact.addressLines) === null || _k === void 0 ? void 0 : _k[0]) !== null && _l !== void 0 ? _l : PeachPayCustomer.billing.address1(), billing_address_2: (_o = (_m = billingContact === null || billingContact === void 0 ? void 0 : billingContact.addressLines) === null || _m === void 0 ? void 0 : _m[1]) !== null && _o !== void 0 ? _o : PeachPayCustomer.billing.address2(), billing_city: (_p = billingContact === null || billingContact === void 0 ? void 0 : billingContact.city) !== null && _p !== void 0 ? _p : PeachPayCustomer.billing.city(), billing_state: (_q = billingContact === null || billingContact === void 0 ? void 0 : billingContact.state) !== null && _q !== void 0 ? _q : PeachPayCustomer.billing.state(), billing_postcode: (_r = billingContact === null || billingContact === void 0 ? void 0 : billingContact.postalCode) !== null && _r !== void 0 ? _r : PeachPayCustomer.billing.postal(), billing_country: (_s = billingContact === null || billingContact === void 0 ? void 0 : billingContact.countryCode) !== null && _s !== void 0 ? _s : PeachPayCustomer.billing.country(), shipping_email: (_t = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.email) !== null && _t !== void 0 ? _t : PeachPayCustomer.shipping.email(), shipping_first_name: (_u = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.givenName) !== null && _u !== void 0 ? _u : PeachPayCustomer.shipping.firstName(), shipping_last_name: (_v = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.familyName) !== null && _v !== void 0 ? _v : PeachPayCustomer.shipping.lastName(), shipping_phone: (_w = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.phone) !== null && _w !== void 0 ? _w : PeachPayCustomer.shipping.phone(), shipping_address_1: (_y = (_x = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.addressLines) === null || _x === void 0 ? void 0 : _x[0]) !== null && _y !== void 0 ? _y : PeachPayCustomer.shipping.address1(), shipping_address_2: (_0 = (_z = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.addressLines) === null || _z === void 0 ? void 0 : _z[1]) !== null && _0 !== void 0 ? _0 : PeachPayCustomer.shipping.address2(), shipping_city: (_1 = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.city) !== null && _1 !== void 0 ? _1 : PeachPayCustomer.shipping.city(), shipping_state: (_2 = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.state) !== null && _2 !== void 0 ? _2 : PeachPayCustomer.shipping.state(), shipping_postcode: (_3 = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.postalCode) !== null && _3 !== void 0 ? _3 : PeachPayCustomer.shipping.postal(), shipping_country: (_4 = shippingContact === null || shippingContact === void 0 ? void 0 : shippingContact.countryCode) !== null && _4 !== void 0 ? _4 : PeachPayCustomer.shipping.country() })));
                if ((_6 = (_5 = result.details) === null || _5 === void 0 ? void 0 : _5.shipping) === null || _6 === void 0 ? void 0 : _6.option) {
                    store.dispatch(updateCartPackageShippingMethod({
                        cartKey: '0',
...
function initSquareCardMethod() {
    var _this = this;
    var _a, _b, _c, _d;
    var config = {
        name: getLocaleText('Card'),
        slug: 'card',
        gateway: 'peachpay_square_card',
        description: '',
        reusable: true,
        assets: {
            title: {
        ...
        supports: {
            minimumTotal: (_a = Feature.metadata(FeatureFlag.SQUARE_CARD, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
            maximumTotal: (_b = Feature.metadata(FeatureFlag.SQUARE_CARD, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
            currencies: (_c = Feature.metadata(FeatureFlag.SQUARE_CARD, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                'ALL'
            ],
            customerCountries: (_d = Feature.metadata(FeatureFlag.SQUARE_CARD, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                'ALL'
            ],
            productTypes: [],
            virtualProducts: true,
    ...
    return {
        ...
        tokenize: function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var payments, cardElement, tokenResult, error_12, _a, sourceId, _, transactionUpdate, response, error1_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            payments = context.payments;
                        ...
                        case 3:
                            ...
                            return [2, [
                                    ...
                                    {
                                        paymentStatus: 'creationfailed',
                                        note: "Square Card element tokenization failed with error: ".concat(error_12.message)
                                    }
                                ]];
                        case 4:
                        ...
                        case 7:
                            ...
                            return [2, [
                                    ...
                                    {
                                        paymentStatus: 'creationfailed',
                                        note: "Verifying Square buyer failed with error: ".concat(error1_1.message)
                                    }
                                ]];
                        case 8: return [2];
                    }
...
function initSquareGooglePayMethod() {
    var _this = this;
    var _a, _b, _c, _d;
    var gpay = null;
    var config = {
        ...
        name: getLocaleText('Google Pay'),
        slug: 'googlepay',
        gateway: 'peachpay_square_googlepay',
        ...
        supports: {
            ...
            minimumTotal: (_a = Feature.metadata(FeatureFlag.SQUARE_GOOGLEPAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
            maximumTotal: (_b = Feature.metadata(FeatureFlag.SQUARE_GOOGLEPAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
            currencies: (_c = Feature.metadata(FeatureFlag.SQUARE_GOOGLEPAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                'ALL'
            ],
            customerCountries: (_d = Feature.metadata(FeatureFlag.SQUARE_GOOGLEPAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                'ALL'
            ],
            productTypes: [],
            virtualProducts: true,
...
function initSquareApplePayMethod() {
    var _a, _b, _c, _d;
    var apay = null;
    ...
    var config = {
        ...
        name: getLocaleText('Apple Pay'),
        slug: 'applepay',
        gateway: 'peachpay_square_applepay',
        ...
        supports: {
            ...
            minimumTotal: (_a = Feature.metadata(FeatureFlag.SQUARE_APPLEPAY, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
            maximumTotal: (_b = Feature.metadata(FeatureFlag.SQUARE_APPLEPAY, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
            currencies: (_c = Feature.metadata(FeatureFlag.SQUARE_APPLEPAY, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                'ALL'
            ],
            customerCountries: (_d = Feature.metadata(FeatureFlag.SQUARE_APPLEPAY, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                'ALL'
            ],
            productTypes: [],
            virtualProducts: true,
...
function setupSquareMethods(account) {
    var paymentMethods = {};
    if (Feature.enabled(FeatureFlag.SQUARE_CARD) && isSquareCapable(account, 'card')) {
        var cardMethod = initSquareCardMethod();
        paymentMethods['card'] = cardMethod;
    }
    if (Feature.enabled(FeatureFlag.SQUARE_GOOGLEPAY) && isSquareCapable(account, 'googlepay')) {
        var googlePayMethod = initSquareGooglePayMethod();
        paymentMethods['googlepay'] = googlePayMethod;
    }
    if (Feature.enabled(FeatureFlag.SQUARE_APPLEPAY) && isSquareCapable(account, 'applepay')) {
        var applePayMethod = initSquareApplePayMethod();
        paymentMethods['applepay'] = applePayMethod;
    }
    var squareProvider = {
        'methods': {}
    ...
    for (var method in paymentMethods) {
        squareProvider.methods[method] = paymentMethods[method].config;
    }
    store.dispatch(registerPaymentProvider({
...
function isSquareCapable(account, selector) {
...
function squarePaymentFlow(context, method, orderService) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, sourceId, verificationId, transactionUpdate, transaction, orderOptions, order, successURL;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    store.dispatch(startModalProcessing());
                ...
                case 1:
                    _a = _b.sent(), sourceId = _a[0], verificationId = _a[1], transactionUpdate = _a[2];
                    return [4, orderService.startTransaction(method.config.gateway)];
                case 2:
                    transaction = _b.sent();
                    if (!(!sourceId || !transaction)) return [3, 4];
                    if (Environment.modalUI.page() === 'returning') {
                        openSlideUpView('payment');
                    }
                ...
                case 4:
                    ...
                    if (verificationId) {
                        orderOptions.peachpay_square_verification_id = verificationId;
                    }
                    return [4, orderService.placeOrder(transaction, orderOptions)];
                case 5:
                    order = _b.sent();
                    if (!(order.result === 'failure')) return [3, 7];
                    return [4, transaction.complete()];
...
function initAuthnetCardMethod() {
    var config = {
        name: getLocaleText('Card'),
        slug: 'card',
        gateway: 'peachpay_authnet',
        showName: true,
        description: "".concat(getLocaleText('After clicking <b>Pay</b>, a window will appear where you can enter your card information.')),
        reusable: false,
        assets: {
            title: {
                src: 'img/marks/credit-card-regular.svg'
...
function setupAuthnetButton(scriptURL) {
    store.subscribe(function () {
        renderAuthnetButtonDisplay(PaymentConfiguration.selectedProvider(), Environment.modalUI.page(), Environment.modalUI.loadingMode(), DefaultCart.total(), scriptURL);
        renderAuthnetButtonLoading(PaymentConfiguration.selectedProvider(), Environment.modalUI.loadingMode());
    });
}
function renderAuthnetButtonDisplay(provider, page, loadingMode, cartTotal, scriptURL) {
    var _a, _b, _c, _d;
    if (provider === 'authnet' && page === 'payment' && !((_a = $qs('.pp-authnet-btn-mobile')) === null || _a === void 0 ? void 0 : _a.classList.contains('AcceptUI')) && !((_b = $qs('.pp-authnet-btn-new')) === null || _b === void 0 ? void 0 : _b.classList.contains('AcceptUI'))) {
        if (window.matchMedia('(max-width: 900px)').matches) {
            $qs('.pp-authnet-btn-mobile', function ($element) { return $element.classList.add('AcceptUI'); });
        }
        else {
            $qs('.pp-authnet-btn-new', function ($element) { return $element.classList.add('AcceptUI'); });
        }
        ((_c = $qs('.pp-authnet-btn-exist')) === null || _c === void 0 ? void 0 : _c.classList.contains('AcceptUI')) ? $qs('.pp-authnet-btn-exist', function ($element) { return $element.classList.remove('AcceptUI'); }) : '';
        loadScript(scriptURL, null, function () { });
    }
    else if (provider === 'authnet' && page === 'returning' && !((_d = $qs('.pp-authnet-btn-exist')) === null || _d === void 0 ? void 0 : _d.classList.contains('AcceptUI'))) {
        $qs('.pp-authnet-btn-exist', function ($element) { return $element.classList.add('AcceptUI'); });
        loadScript(scriptURL, null, function () { });
    }
    if (provider === 'authnet' && (page === 'payment' || page === 'returning') && cartTotal > 0) {
        $qsAll('.authnet-btn-container', function ($element) { return $element.classList.remove('hide'); });
    }
    else {
        $qsAll('.authnet-btn-container', function ($element) { return $element.classList.add('hide'); });
    }
    if (provider === 'authnet' && (page === 'payment' || page === 'returning') && loadingMode !== 'loading' && cartTotal > 0) {
        $qsAll('.authnet-btn', function ($element) { return $element.classList.remove('hide'); });
    }
    else {
        $qsAll('.authnet-btn', function ($element) { return $element.classList.add('hide'); });
    }
}
function renderAuthnetButtonLoading(provider, mode) {
    if (provider !== 'authnet') {
        return;
    }
    if (mode === 'finished') {
        $qsAll('.authnet-btn', function ($element) { return $element.disabled = false; });
    }
    else {
        $qsAll('.authnet-btn', function ($element) { return $element.disabled = true; });
    }
    if (mode === 'loading') {
        $qsAll('.pp-btn-spinner-container', function ($element) { return $element.classList.remove('hide'); });
    }
    ...
    if (mode === 'processing') {
        $qsAll('.authnet-btn > .button-text', function ($element) { return $element.innerHTML = getLocaleText('Processing'); });
        $qsAll('.modal-lock-icon', function ($element) { return $element.classList.add('hide'); });
        $qsAll('.authnet-btn-spinner', function ($element) { return $element.classList.remove('hide'); });
    }
    else {
        $qsAll('.authnet-btn > .button-text', function ($element) { return $element.innerHTML = "".concat(getLocaleText('Pay'), " ").concat(formatCurrencyString(DefaultCart.total())); });
        $qsAll('.authnet-btn-spinner', function ($element) { return $element.classList.add('hide'); });
    }
}
function initAuthNetPaymentProvider(orderService, _pluginCapabilities) {
    if (!Feature.enabled(FeatureFlag.AUTHNET)) {
        return;
    }
    var env = Environment.testMode();
    var clientKey = Feature.metadata(FeatureFlag.AUTHNET, 'client_key');
    var loginID = Feature.metadata(FeatureFlag.AUTHNET, 'login_id');
    var scriptURL = env ? 'https://jstest.authorize.net/v3/AcceptUI.js' : 'https://js.authorize.net/v3/AcceptUI.js';
    if (loginID && clientKey) {
        $qsAll('button.authnet-btn', function ($el) {
            $el.dataset.apiloginid = loginID;
            $el.dataset.clientkey = clientKey;
        });
        var paymentMethods = setupAuthnetMethods();
        activateAuthnetMethods(paymentMethods, orderService);
        setupAuthnetButton(scriptURL);
        window.authnetResponseHandler = authnetResponseHandler;
    }
}
function setupAuthnetMethods() {
    var paymentMethods = {};
    var cardMethod = initAuthnetCardMethod();
    paymentMethods['card'] = cardMethod;
    var authnetProvider = {
        'methods': {}
    };
    for (var method in paymentMethods) {
        authnetProvider.methods[method] = paymentMethods[method].config;
    }
    store.dispatch(registerPaymentProvider({
        'authnet': authnetProvider
    }));
    return paymentMethods;
}
function activateAuthnetMethods(methods, orderService) {
    var targetNode = $qs('#dataValue');
    var config = {
        attributes: true,
        childList: false,
        subtree: false
    ...
    var observer = new MutationObserver(function (mutations) {
        for (var _i = 0, mutations_1 = mutations; _i < mutations_1.length; _i++) {
            ...
            if (mutation.type === 'attributes') {
                var dataValue = $qs('#dataValue').value;
                var dataDescriptor = $qs('#dataDescriptor').value;
                if (dataValue && dataDescriptor) {
                    var method = methods[PaymentConfiguration.selectedProviderMethod()];
                    if (!method || PaymentConfiguration.selectedProvider() !== 'authnet') {
                        return;
                    }
                    authnetPaymentFlow(method, orderService);
                }
            }
        }
    });
...
function authnetPaymentFlow(method, orderService) {
    return __awaiter(this, void 0, void 0, function () {
        var transaction, order, payment, successURL;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store.dispatch(startModalProcessing());
                ...
                case 2:
                    order = _a.sent();
                    if (!(order.result === 'failure')) return [3, 4];
                    return [4, (transaction === null || transaction === void 0 ? void 0 : transaction.complete())];
                case 3:
                    _a.sent();
                    store.dispatch(stopModalLoading());
                    return [2];
                case 4: return [4, createAuthnetPayment(order, transaction, 'card')];
                case 5:
                    payment = _a.sent();
                    if (!!payment.success) return [3, 7];
                    displayAuthnetError(payment.message);
...
function createAuthnetPayment(order, transaction, paymentMethod) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var dataValue, dataDescriptor, response, error_15;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    dataValue = $qs('#dataValue').value;
                    dataDescriptor = $qs('#dataDescriptor').value;
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4, fetchHostWindowData('pp-create-authnet-payment', {
                            session: {
                                id: PeachPayOrder.sessionId()
                            },
                            transaction: {
                ...
                case 3:
                    ...
                    if (error_15 instanceof Error) {
                        captureSentryException(new Error("Failed to create Authnet payment"), {
                            'exception': error_15
                        });
                    }
                    transaction === null || transaction === void 0 ? void 0 : transaction.update({
                        paymentStatus: 'failed',
                        note: "Unknown error creating Authnet payment :: ".concat(JSON.stringify(error_15))
                    });
                    return [2, {
                            success: false
                        }];
...
function authnetResponseHandler(response) {
    if (response.messages.resultCode === 'Error') {
        ...
        if (!$qs('#dataValue').value) {
            $qs('#dataDescriptor').value = response.opaqueData.dataDescriptor;
            $qs('#dataValue').value = response.opaqueData.dataValue;
        }
    }
}
function displayAuthnetError(error) {
    $qsAll('.pp-pm-error-text', function ($el) { return $el.remove(); });
    if (!error) {
        return;
    }
    var method = PaymentConfiguration.selectedProviderMethod();
    var $container = $qsAll("div.pp-pm-saved-option[data-provider=\"authnet\"][data-method=\"".concat(method, "\"][data-index=\"\"]"));
    $container.forEach(function ($el) {
            ...
            switch (_b.label) {
                ...
                case 7:
                    ...
                    defaultOrderFlow(orderService, transaction, {
                        'peachpay_session_id': PeachPayOrder.sessionId(),
                        'peachpay_transaction_id': (_a = transaction === null || transaction === void 0 ? void 0 : transaction.getId()) !== null && _a !== void 0 ? _a : '',
                        'purchase_order_number': purchaseOrderNumber
                    });
                    return [2];
            }
...
function getPurchaseOrderMethodConfiguration() {
    ...
    return {
        ...
        slug: 'purchase_order',
        description: "<span>".concat(getDescription4(), "</span>"),
        reusable: false,
        requireInput: true,
        showName: true,
        assets: {
        ...
        supports: {
            minimumTotal: (_a = Feature.metadata(FeatureFlag.PURCHASE_ORDER, 'minimum_charge')) !== null && _a !== void 0 ? _a : undefined,
            maximumTotal: (_b = Feature.metadata(FeatureFlag.PURCHASE_ORDER, 'maximum_charge')) !== null && _b !== void 0 ? _b : undefined,
            currencies: (_c = Feature.metadata(FeatureFlag.PURCHASE_ORDER, 'supported_currencies')) !== null && _c !== void 0 ? _c : [
                'ALL'
            ],
            customerCountries: (_d = Feature.metadata(FeatureFlag.PURCHASE_ORDER, 'supported_countries')) !== null && _d !== void 0 ? _d : [
                'ALL'
            ],
            productTypes: [],
            virtualProducts: true,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    initAuthNetPaymentProvider(orderService, pluginCapabilities);
                    return [4, Promise.all([
                            initStripePaymentProvider(orderService),
