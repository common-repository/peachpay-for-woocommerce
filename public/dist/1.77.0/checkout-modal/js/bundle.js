...
var peachpayi18n = {
    ...
    "el": {
        ...
        "Account name": "Ονομα λογαριασμού",
    ...
    store.subscribe(function () {
        ...
        if (Environment.modalUI.page() === 'info' || Environment.modalUI.page() === 'shipping') {
            if (Carts.virtual() && Feature.enabled(FeatureFlag.VIRTUAL_PRODUCT_FIELDS)) {
                ...
                hideShippingDetails(false, (_o = (_m = message.phpData) === null || _m === void 0 ? void 0 : _m.billing_fields) !== null && _o !== void 0 ? _o : [], (_q = (_p = message.phpData) === null || _p === void 0 ? void 0 : _p.billing_fields_order) !== null && _q !== void 0 ? _q : []);
            }
...
function hideShippingDetails(hide, fieldData, fieldOrder) {
    ...
    var stateFieldInfo = (_c = (_b = (_a = GLOBAL.phpData) === null || _a === void 0 ? void 0 : _a.wc_location_info) === null || _b === void 0 ? void 0 : _b.country_locale_data[info.country()]) === null || _c === void 0 ? void 0 : _c.state;
    var postalFieldInfo = (_f = (_e = (_d = GLOBAL.phpData) === null || _d === void 0 ? void 0 : _d.wc_location_info) === null || _e === void 0 ? void 0 : _e.country_locale_data[info.country()]) === null || _f === void 0 ? void 0 : _f.state;
    if (hide) {
