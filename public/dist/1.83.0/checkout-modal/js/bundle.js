...
function renderCustomerHeader(customer) {
    ...
    if (fullName.replace(/\s/g, '') === '' && shortAddress.replace(/\s/g, '') === '') {
    ...
    $qsAll("".concat(Environment.customer.existing() ? '#existing-' : '.', "full-name"), function ($element) { return $element.innerHTML = fullName; });
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    return [3, 6];
                case 5:
                    alert("Error saving form: ".concat(PeachPayOrder.errorMessage()));
                    store.dispatch(stopModalLoading());
                    _c.label = 6;
                case 6: return [2];
            }
...
function consumeCartCalculationResponse(response) {
    ...
    if (response.data) {
        ...
        if (DefaultCart.contents().length === 0) {
            ...
            store.dispatch(setOrderError("<span>".concat(getLocaleText('The merchant has not enabled any payment methods'), "</span>")));
        }
    }
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, loadScript('https://js.stripe.com/v3/', null, function () {
...
function isPaymentMethodActive(account, selector) {
    ...
    var pmData = Feature.metadata(FeatureFlag.STRIPE, selector);
    var enabled = Boolean(pmData === null || pmData === void 0 ? void 0 : pmData.enabled);
...
function createAuthnetPayment(order, transaction, paymentMethod) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var dataValue, dataDescriptor, response, error_18;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 3:
                    ...
                    transaction === null || transaction === void 0 ? void 0 : transaction.update({
                        paymentStatus: 'failed',
                        note: "Unknown error creating Authnet payment :: ".concat(JSON.stringify(error_18))
                    });
                    return [2, {
                            success: false
                        }];
