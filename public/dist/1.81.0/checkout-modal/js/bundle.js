...
function checkRequiredFields() {
    ...
    if (shouldCheckInfoForm) {
        ...
        if (!primaryFormValidity) {
            ...
            (_c = $qs("".concat(primaryFormToCheck))) === null || _c === void 0 ? void 0 : _c.reportValidity();
            return false;
        }
        if (modalPage === 'shipping' && PeachPayCustomer.shipToDifferentAddress()) {
            (_d = $qs("#pp-different-shipping-details")) === null || _d === void 0 ? void 0 : _d.reportValidity();
            return false;
        }
    }
...
function initAmazonPayPaymentProvider(orderService) {
    ...
    loadScript('https://static-na.payments-amazon.com/checkout.js', 'amazon', function () {
