 ...
 */
function pp_express_checkout_block_express_checkout_block_block_init() {
	if ( ! function_exists( 'register_block_type' ) ) {
		// Block editor is not available.
		return;
	}

	register_block_type( PEACHPAY_ABSPATH . '/public/dist/express-checkout' );
}
add_action( 'init', 'pp_express_checkout_block_express_checkout_block_block_init' );
