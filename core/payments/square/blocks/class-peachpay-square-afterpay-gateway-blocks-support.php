<?php
/**
 * PeachPay Square Afterpay gateway block.
 *
 * @package PeachPay
 */
 ...
 * .
 */
final class PeachPay_Square_Afterpay_Gateway_Blocks_Support extends AbstractPaymentMethodType {

	/**
	 * The gateway instance.
	 *
	 * @var PeachPay_Square_Afterpay_Gateway
	 */
	private $gateway;
	 ...
	 * @var string
	 */
	protected $name = 'peachpay_square_afterpay';
