...
final class PeachPay_Square_Integration {
	...
	protected function woocommerce_blocks_loaded() {
		require_once PEACHPAY_ABSPATH . 'core/payments/square/blocks/class-peachpay-square-afterpay-gateway-blocks-support.php';
		...
		add_action(
			...
			function ( Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry ) {
				$payment_method_registry->register( new PeachPay_Square_Afterpay_Gateway_Blocks_Support() );
