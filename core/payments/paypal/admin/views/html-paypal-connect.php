		...
		<div class="flex-col gap-12 ai-center buttons-container">
			...
			<?php elseif ( ! peachpay_is_test_mode() ) : ?>
				...
				<span>
					<?php
						//phpcs:ignore
						echo peachpay_build_read_tutorial_section( 'https://www.notion.so/peachpay/Connecting-PayPal-eeea16fc89924a6bb9da07b80f055d66' );
					?>
				</span>
			<?php endif; ?>
		</div>
	...
	<div class="provider-info">
		...
		<div class="provider-info">
			...
			<span>
				...
				<a href="https://www.notion.so/peachpay/About-our-service-fee-105d5292afd780f4b320e3f964264eff"><?php echo esc_html( PeachPay::service_fee_percentage() * 100 ); ?><?php esc_html_e( '% service fee', 'peachpay-for-woocommerce' ); ?></a>
