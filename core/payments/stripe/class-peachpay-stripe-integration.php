...
final class PeachPay_Stripe_Integration {
	...
	protected function woocommerce_blocks_loaded() {
		...
		require_once PEACHPAY_ABSPATH . 'core/payments/stripe/blocks/class-peachpay-stripe-googlepay-payment-blocks-support.php';
		...
		add_action(
			...
			function ( Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry ) {
				...
				$payment_method_registry->register( new PeachPay_Stripe_GooglePay_Payment_Blocks_Support() );
			}
		);
	}
