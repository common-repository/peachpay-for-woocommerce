		...
		<div class="flex-col gap-12 ai-center buttons-container">
			...
			<?php else : ?>
				...
				<span>
					<?php
						//phpcs:ignore
						echo peachpay_build_read_tutorial_section( 'https://www.notion.so/peachpay/Connecting-Stripe-105d5292afd7800493c1d4296ff809ac' );
					?>
				</span>
			<?php endif; ?>
		</div>
		...
		<?php if ( PeachPay::service_fee_enabled() ) : ?>
			<div class="provider-info">
				...
				<span>
					...
					<a href="https://www.notion.so/peachpay/About-our-service-fee-105d5292afd780f4b320e3f964264eff" target="_blank"><?php echo esc_html( PeachPay::service_fee_percentage() * 100 ); ?><?php esc_html_e( '% service fee', 'peachpay-for-woocommerce' ); ?></a>
