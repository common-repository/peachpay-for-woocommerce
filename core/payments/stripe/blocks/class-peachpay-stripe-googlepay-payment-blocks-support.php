<?php
/**
 * PeachPay Stripe GooglePay WooCommerce Blocks Support file.
 *
 * @package PeachPay
 */
...
/**
 * GooglePay Payments Blocks integration
 *
 * @since 1.0.3
 */
final class PeachPay_Stripe_GooglePay_Payment_Blocks_Support extends AbstractPaymentMethodType {

	/**
	 * The gateway instance.
	 *
	 * @var PeachPay_Stripe_GooglePay_Gateway
	 */
	private $gateway;
	 ...
	 * @var string
	 */
	protected $name = 'peachpay_stripe_googlepay';
