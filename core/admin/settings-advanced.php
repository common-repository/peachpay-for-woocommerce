...
function peachpay_settings_advanced_main() {
	...
	add_settings_section(
		'peachpay_section_custom_button_placement',
		'',
		'',
		'peachpay'
	);
...
function peachpay_custom_css_section() {
	...
	<div class="peachpay-setting-section">
		<div>
			<h3><?php esc_html_e( 'Button classes', 'peachpay-for-woocommerce' ); ?></h3>
			<?php peachpay_field_button_class_cb(); ?>
		</div>
		<div>
			<h3><?php esc_html_e( 'Button CSS', 'peachpay-for-woocommerce' ); ?></h3>
...
function peachpay_custom_js_section() {
	...
	<div class="peachpay-setting-section">
		<div>
			<h3><?php esc_html_e( 'Checkout JS', 'peachpay-for-woocommerce' ); ?></h3>
...
function peachpay_custom_button_placement() {
	?>
		<div class="peachpay-setting-section">
			<div>
				<p class="description"><?php echo esc_html_e( 'For each page, you can enter a CSS selector where the button should appear. If empty, it will appear in a default location.', 'peachpay-for-wooocommerce' ); ?></p>
			</div>
			<?php
			peachpay_admin_input(
				...
				peachpay_get_settings_option( 'peachpay_advanced_options', 'custom_target_product_page', null ),
				'Product page',
				'',
				array(
					'placeholder' => __( '#sampleTarget' ),
					'input_type'  => 'text',
				)
			);
			peachpay_admin_input(
				...
				peachpay_get_settings_option( 'peachpay_advanced_options', 'custom_target_cart_page', null ),
				'Cart page',
				'',
				array(
					'placeholder' => __( '#sampleTarget' ),
			...
			peachpay_admin_input(
				...
				peachpay_get_settings_option( 'peachpay_advanced_options', 'custom_target_checkout_page', null ),
				'Checkout page',
				'',
				array(
					'placeholder' => __( '#sampleTarget' ),
