...
class PeachPay_Admin {
	...
	public function add_plugin_list_links( $links ) {
		array_unshift( $links, '<a href="https://peachpay.notion.site/8526d0ee6f984b679afd4e9a60fd25d7?v=712cb377635f47dd8c8a920a089ab7b4" target="_blank" rel="noopener noreferrer">' . __( 'Docs', 'peachpay-for-woocommerce' ) . '</a>' );
