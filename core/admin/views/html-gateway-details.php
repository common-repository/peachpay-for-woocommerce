...
<div id="peachpay-gateway-details" class="settings-container">
	...
	if ( ( 'Google Pay' === $gateway->title || 'Apple Pay' === $gateway->title ) && ! $gateway->needs_setup() ) {
		$url = 'Google Pay' === $gateway->title ? 'https://www.notion.so/peachpay/Google-Pay-Requirements-105d5292afd780f9a0c7f09f3f1ac91f' : 'https://www.notion.so/peachpay/Apple-Pay-requirements-105d5292afd780ec862cc7ff8c0b0f60';
		?>
